...
1. <strong>Aşağıdakilerden hangisi bilgilendirme tasarımında kullanılan g&ouml;rsellerden biri <u>değildir</u>?</strong>
    ...
    - E-) Diyagram
    ***
1. <strong>Aşağıdakilerden hangisi bilgiyi kelimeler, semboller, diyagramlar, resim ve tipografi yardımıyla alıcıya doğrudan aktaran g&ouml;rsel iletişim tasarımı i&ccedil;erisindeki bir alandır?</strong><br />
...
1. <strong>Aşağıdakilerden hangisi bilgilendirme tasarımlarının &ouml;ğrenme &uuml;zerindeki etkileri arasında <u>yer almaz</u>?</strong>
    ...
    - C-) Soyut kavram ve konuları somutlaştırarak anlaşılabilirliğin artırılmasında etkilidir.<br type="_moz" />
    - D-) &Ouml;ğrenen ve &ouml;ğrenilen arasındaki ilişkinin kolay anlaşılır h&acirc;le gelmesini sağlar.<br type="_moz" />
