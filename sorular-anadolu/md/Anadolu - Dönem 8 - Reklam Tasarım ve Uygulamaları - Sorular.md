...
1. Aşağıdakilerden hangisi bir satışı gerçekleştirmek için potansiyel alıcılarla yapılan görüşme<br />esnasında gerçekleştirilen sözlü sunum faaliyetleridir?
    ...
    > **Açıklama:** Kişisel satış, bir satışı gerçekleştirmek için potansiyel alıcılarla yapılan görüşme esnasında gerçekleştirilen sözlü sunum faaliyetleridir (Tek ve Özgül, 2007). Bir mağaza personelinin
...
1. Markaların daha prestijli ve kaliteli görünmesine yardımcı olması aşağıdaki reklam işlevlerinden hangisi ile ilişkilendirilir?
    ...
    > **Açıklama:** Değer katma işlevi: Hedef kitlenin reklamı yapılan ürün, hizmete ya da markaya yönelik olumlu algısı, o markaya ya da ürün/hizmetlere yönelik olumlu tutum geliştirmesine ve bir karar sürecinde hedef kitlenin
...
1. Aşağıdakilerden hangisi tarihte yayımlanan ilk televizyon reklamıdır?
    ...
    > **Açıklama:** 1941 yılına kadar televizyonlarda reklam yayımlanması yasaya aykırıydı. 1941 yılında ise televizyonlar birer reklam mecrasına dönüşmüştür. Bu tarihte ilk olarak Bulova Watch şirketi ilk reklam filmini yayımlamıştır.
...
1. Aşağıdaki reklam ajansı türlerinden hangisinde medya planlama, stratejik planlama gibi çalışma birimleri bulunmaz?
    ...
    > **Açıklama:** Yaratıcı butik reklam ajansları görece sınırlı hizmet sunan ajanslardır. Bu ajanslarda medya
...
1. Aşağıdakilerden hangisi reklam fikrinin üretime geçmesini sağlayan birimdir?
    ...
    > **Açıklama:** Prodüksiyon Birimi reklam ajansı tarafından oluşturulan reklam fikrinin üretime geçmesini sağlayan birimdir. Örneğin reklam ajansı bir televizyon reklam filmi yayımlayacağı zaman bu reklamın yayımlanmasında prodüksiyon birimi görev alır.
...
1. Banner reklamlar aşağıdaki reklam mecralarından hangisinde kullanılan reklam türüdür?
    ...
    > **Açıklama:** Dijital reklamcılığın ilk örnekleri olarak banner reklamlar karşımıza çıkmıştır. 1994 yılı internet kullanıcılarının banner reklamlarla karşılaştığı yıldır.
...
1. Bir ihtiyacın veya isteğin karşılanması gerektiğine karar veren kişiye ne ad verilir?
    ...
    > **Açıklama:** Teşvik eden (Tetikleyen): Bir ihtiyacın veya isteğin karşılanması gerektiğine karar veren kişi.
...
1. Reklama geometrik oran vermek için önceden belirlenmiş bir ızgara içinde bir dizi dikey ve yatay çizgi, dikdörtgen ve kare kullanılması ve geometrik formlarla bölümlenmiş sayfa düzeni içerisinde sayfa bileşenlerinin bu alanlar içerisinde yer almasına dayalı sayfa düzeni türü aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** Mondrian sayfa düzeni
...
1. Aşağıda basılı reklamcılığa ilişkin verilen ifadelerden hangisi doğrudur?
    ...
    > **Açıklama:** Basılı reklam okurları daha heterojen olarak dağılır.
...
1. Aşağıdaki şıklardan hangisi "İnternet Reklamcılığının" tanımıdır?
    ...
    > **Açıklama:** Hedef kitleye yönelik reklam mesajlarını çevrim içi kanallar olan arama motorları, web siteleri, bloglar, sosyal medya aracılığı ile dijital ortamda iletilmesidir.
...
1. Aşağıdaki şıklardan hangisi internet reklamcılığında göz önünde bulundurulması gereken unsurlardan birisidir?
    ...
    > **Açıklama:** Hedefleme kriterleri; Reklamın ulaşmayı amaçladığı belirli hedef kitle, demografik
...
1. "Snapchat" in tanımı aşağıdaki şıklardan hangisidir?
    ...
    > **Açıklama:** Akıllı telefonlar için geliştirilmiş, platformlar arası çalışma özelliğine sahip bir anlık mesajlaşma uygulamasıdır.
...
1. Aşağıdaki şıklardan hangisi "Dinamik Eylem Çağrısı"nı tanımlar ve örneklendirir?
    ...
    > **Açıklama:** Dijital pazarlama stratejilerinde kullanıcıları belirli bir eylemi gerçekleştirmeye teşvik etmek için kullanılan metin veya görsel ögelerdir. “Hemen Satın Al” veya “Şimdi Kaydol” gibi ifadeler örnekleri olarak verilebilir.
...
1. "Üçüncü taraf çerezleri" ne demektir?
    ...
    > **Açıklama:** Kullanıcının ziyaret ettiği alandan farklı bir alan adına ait bir web sitesi tarafından kullanıcının cihazına yerleştirilen bir çerezdir. Çerez, bir web sitesinin kullanıcının bilgisayarına yerleştirdiği bilgilerdir.
...
1. Tüketicilerin sanal ortamda ürün ve hizmetlerle etkileşime geçmesine olanak tanıyan bir reklam türü aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** İnteraktif VR deneyimleri
...
1. "Banner reklamlar" hangi tarihte ortaya çıkmış ne tür reklamlardır?
    ...
    > **Açıklama:** 1994 yılında kullanıcıların dikkatini çekme ve istenilen tepkiyi tetikleme yöntemi olarak ortaya çıkmıştır. Renkli animasyonlar ve dinamik görsellerin kullanıldığı reklamlardır.
...
1. Sanal gerçekliğin bir türü olan "Artırılmış gerçekliğin (AR- augmented reality)" tanımı aşağıdakilerden hangisidir?
    ...
    > **Açıklama:** AR, gerçek dünyanın üzerine eklenen veya gerçek dünyayla birleştirilen sanal nesnelerle kullanıcının gerçek dünyayı görmesine olanak tanıyarak, gerçekliğin tamamen yerini almak yerine onu tamamlayan sanal gerçeklik türüdür.
...
1. Gündelik yaşantımızda dış dünyadan gelen uyarıcılarla oluşan duyumlarımızı sürekli bir yorumlama işlemine tabi tutarız. Dolayısıyla gördüğümüzü anlama sürecinde aşağıda görülen noktalı boşluklara şıklardan hangisi gelmelidir?<br />"............. bize orada bir şey olduğunu söylerken,.............. bize o şeyin ne olduğunu söyler."
    ...
    > **Açıklama:** Duyularımız- algılarımız
...
1. Gestalt psikologlarına göre beynimiz, ayrı ayrı parçaların anlamlı bir desen ve algı oluşturmak için ne şekilde organize edileceğini belirleyen bir dizi kurala uymaktadır. Aşağıdaki şıklardan hangisi bu kurallardan birisidir?
    ...
    > **Açıklama:** Tamamlama kuralı (closure)
...
1. Aşağıdaki şıklardan hangisi "Metafor (Eğretileme)"un tanımıdır?
    ...
    > **Açıklama:** Bilinmeyen bir şeyi, bilinen bir şey açısından ifade etmektir. Bilinmeyenlerin anlamı, bilinenlerin araçlarını kullanarak aktarılmaktadır.
...
1. Ekranda gördüğümüz her hareket bir anlam içermektedir. Yüze yapılan yakın çekim oyuncunun hissine odaklanması gibi. Bu doğrultuda kameranın "Geniş Çekimi" bir gösteren olarak hangi gösterileni açıklar?
    ...
    > **Açıklama:** Bağlam, kapsam, kamusal uzaklık
