# Sayısal Fotoğraf (Dönem 3) - Alıştırma Soruları

## Unite 1
1. <strong>İlk kompakt flaş kart kullanan fotoğraf makinesinin piyasaya sürüldüğü yıl aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) 1996**
    - B-) 1927
    - C-) 1901
    - D-) 1974
...
1. <strong>Filmle çalışan analog fotoğraf makinelerinden farklı olarak dijital makinelerdeki görüntü kayıt alanı aşağıdakilerden hangisidir?</strong>
    ...
    - E-) Diyafram
    <hr />
1. <strong>Kompakt makinelerden daha sağlam ve dayanıklı olan ve genellikle aşırı hızlı, hareketli işlerde ve sürekli çekimlerde kullanmaya elverişli yapıdaki kameralar aşağıdakilerden hangisidir?</strong>
    ...
    - E-) Analog kameralar
    <hr />
1. <strong>İleri amatör ve profesyonel birçok fotoğrafçıya mükemmel görüntü kalitesi ve ciddi kullanım olanakları sunan, üzerinde değiştirilebilir lens olan ve çekim öncesi görülen çerçevenin çekimde de aynı şekilde sensöre düşürülmesi ile görüntü oluşturan fotoğraf makinesi türü aşağıdakilerden hangisidir?</strong>
    - A-) SLR makineler
    - B-) Analog makineler
    ...
    - E-) Klasik makineler
    <hr />
1. I. İki veya daha fazla lenslidir.<br />II. Lens sayısı kadar görüntü algılayıcısına sahiptir.<br />III. İnsanın görme biçimini simüle eder.<br /><strong>Yukarıdakilerden hangisi ya da hangileri stereo kameraların özellikleri arasında yer alır?</strong>
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) I ve II
    - D-) II ve III
    - **Cevap E-) I, II ve III**
    <hr />
1. <strong>DSLR makinelerde fiziki perde sistemi en fazla 1/8000 enstantane hızını verirken aynasız makinelerdeki elektronik perdenin çıkabileceği enstantane hızı aşağıdakilerden hangisidir?</strong>
    - A-) 1/10.000
    - B-) 1/20.000
    - C-) 1/30.000
    - **Cevap D-) 1/40.000**
    ...
    <hr />
## Unite 4
1. <strong>Yakın tarihlerde küçük sensörlü bir makine gövdesi için üretilen ve 35 mm’de karşılığı 24 - 3000 mm’ye denk gelen, değişken odaklı (zoom) lensin optik yaklaştırma oranı aşağıdakilerden hangisidir?</strong>
    - A-) 24 kat
    - B-) 50 kat
    - **Cevap C-) 125 kat**
    - D-) 250 kat
