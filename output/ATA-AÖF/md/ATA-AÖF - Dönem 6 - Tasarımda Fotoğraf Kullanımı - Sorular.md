...
## Unite 1
1. <strong>Güncel araştırmalar ışığında bilinen en eski duvar resmi günümüzden kaç yıl önce yapılmıştır?</strong>
    - A-) 2.050
    - B-) 1.200
    - C-) 200.000
    - **Cevap D-) 45.000**
...
1. <strong>Aşağıdakilerden hangisi tasarım kelimesinin karşıladığı anlamlardan biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Türk Dil Kurumuna göre aşağıdakilerden hangisi sanat kelimesinin karşıladığı anlamlardan biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>İnsanoğlunun görme eylemini anlama, gördüklerini yakalama ve görüntüyü yansıtma çabasını incelerken karşımıza çıkan en temel bilimsel buluş aşağıdakilerden hangisidir?</strong>
    - A-) Büyülü fener
    ...
    <hr />
1. <strong>1826 yılında Nicéphore Niépce isimli öncü tarafından elde edilen görüntü klasik manada fotoğrafın ilk örneğini oluşturmaktadır. Bu görüntüde aşağıdakilerden hangisi konu olarak gösterilebilir?</strong>
    ...
    - E-) 3 aylık bir bebek
    <hr />
1. Sanayi devrimlerinin sonuncusu olan ve içinde yaşadığımız dönemi de kapsayan ………….. sadece endüstri alanında değil, sanat, eğitim, sağlık ve benzeri pek çok alanda tüm dünyayı etkiler ve değiştirir niteliktedir.<br /><strong>Parafta boş bırakılan yere gelmesi gereken terim aşağıdakilerden hangisidir?</strong>
    - A-) Endüstri 1.0
    - B-) Fransız Devrimi
    ...
    - E-) Endüstri 2
    <hr />
1. <strong>İlk dijital görsel olarak kabul edilen dijital dosyada model olarak aşağıdakilerden hangisi kullanılmıştır?</strong>
    ...
    - E-) Dinozor iskeleti
    <hr />
1. <strong>Fotoğraflar kullanarak 3 boyutlu modellemeler elde edilebilen bir teknik olarak tanımlanan yönteme ne ad verilir?</strong>
...
1. <strong>Aşağıdakilerden hangisi tasarım kelimesinin karşıladığı anlamlardan biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Fotoğraflar kullanarak 3 boyutlu modellemeler elde edilebilen bir teknik olarak tanımlanan yöntem aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Fotogrametri**
    - B-) After Effect
    - C-) Endüstri 2.0
    - D-) Deep Fake
...
1. <strong>Ritim ve hareket konusundaki ifadelerden hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi tasarımda önem sırası anlamına gelir?</strong>
    - A-) Kompozisyon
    - **Cevap B-) Hiyerarşi**
    - C-) Hareket
    - D-) Düzen
    - E-) Denge
    <hr />
1. <strong>Aşağıdaki çiftlerden hangisi tasarımda zıtlık yaratmak için kullanılabilecek karşıt unsurlardan <u>değildir</u>?</strong>
    - A-) Büyük – küçük
    - B-) Dolu – boş
    - C-) Dokulu – dokusuz
    - **Cevap D-) Mat – opak**
    - E-) Aydınlık – karanlık
    <hr />
1. <strong>Kompozisyonda/tasarımda belli bir görsel elemanı öne çıkarmak için yapılan düzenlemeye ne ad verilir?</strong>
    - **Cevap A-) Vurgu**
    - B-) Ünlem
    - C-) Dikkat
    - D-) Denge
...
1. <strong>Yan yana gelmiş noktalar dizimine ne ad verilir?</strong>
    ...
    - E-) Boşluk
    <hr />
1. <strong>Aşağıdakilerden hangisi şekil türlerinden biri <u>değildir</u>?</strong>
    - A-) Organik
    - **Cevap B-) Modern**
    - C-) Geometrik
    - D-) Rastlantısal
    - E-) Figüratif
    <hr />
1. <strong>Çoğunlukla denge, güven, stabil olma durumu gibi kavramlarla ilişkilendirilen şekil hangisidir?</strong>
    - A-) Daire
    - B-) Eşkenar üçgen
    - C-) Küre
    - D-) Piramit
    - **Cevap E-) Kare**
    <hr />
1. <strong>Desen oluşumunda en önemli unsur aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Tekrar**
    - B-) Boşluk
    - C-) Hiyerarşi
    - D-) Vurgu
...
1. <strong>Aşağıdakilerin hangisinde ana (birincil) renkler doğru ve eksiksiz olarak belirtilmiştir?</strong>
    ...
    - E-) Mavi, mor, kırmızı
    <hr />
1. <strong>Aşağıdaki renk çiftlerinden hangisinin her ikisi de sıcak renklerdendir?</strong>
    - A-) Mavi ve yeşil
    - B-) Mavi ve mor
    - C-) Kırmızı ve mavi
    ...
    <hr />
## Unite 3
1. <strong>Fotoğraf sözcüğünü oluşturan foton-grafi sözcüklerinin karşılığı aşağıdakilerden hangisidir?</strong>
    - A-) Resim-Yakalama
    - B-) Resim-Boyama
    - C-) Işık-Resim
    - **Cevap D-) Işık-Yazı**
...
1. <strong>Denge ile tanımlamaların hangi doğrudur?</strong>
    ...
    <hr />
1. <strong>Portre fotoğrafı çekilirken kameranın fotoğrafı çekilen kişinin boy hizasının altında konumlandırılmasıyla aşağıdakilerden hangisi elde edilebilir?</strong>
...
1. <strong>Pozitif alanın doğru tanımlaması aşağıdakilerden hangisinde doğru olarak verilmiştir?</strong>
    ...
    <hr />
1. <strong>Üçler kuralının doğru kullanımı hangi şıkta doğru olarak verilmiştir?</strong>
    ...
    <hr />
1. <strong>Bir nesnenin veya kişini üç boyutunun vurgulanması istenilen bir fotoğrafta ışığın hangi konumda olması daha uygundur?</strong>
...
1. <strong>Doğal ışık kaynakları hangi şıkta doğru olarak verilmiştir?</strong>
    ...
    - E-) Şömine, odun alevi
    <hr />
1. <strong>Fotoğrafta üçgen kompozisyonun kullanımı ile ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>Fotoğrafta çizgilerle ilgili aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
...
1. <strong>Aşağıdakilerin hangisinde doğal ışık kaynağı doğru olarak verilmiştir?</strong>
    ...
    <hr />
1. <strong>F1.4 için aşşağıdakilerden hangisi söylenebilir?</strong>
    ...
    <hr />
## Unite 4
1. <strong>Aşağıdakilerden hangisi fotoğrafın iletişim aracı olma özelliklerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi bir fotoğrafın içeriğinde <u>yer almaz</u>?</strong>
    - A-) Duygu
    - **Cevap B-) Perspektif**
    - C-) Renk
    - D-) Işık
...
1. <strong>Aşağıdakilerden hangisi fotoğrafın özelliklerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdaki seçeneklerden hangisi fotoğrafın izleyiciye ulaşıncaya kadar ki geçen süreçte <u>yer almaz</u>?</strong>
    ...
    - E-) İşleme süreci
    <hr />
1. <strong>Aşağıdaki seçeneklerden hangisi düşünce sürecinde <u>yer almaz</u>?</strong>
    - A-) Amaç belirlenir.
    ...
    <hr />
1. <strong>Aşağıdaki seçeneklerden hangisi ön hazırlık sürecinde <u>yer almaz</u>?</strong>
    ...
    <hr />
1. I. Eyfel Kulesi<br />II. Çin Setti<br />III. Mısır Piramitleri<br /><strong>Yukarıdakilerden hangisi ya da hangileri nesnel ve evrensel simgeler arasında yer alır?</strong>
    - A-) Yalnız I
    - B-) Yalnız III
    - C-) I ve II
    - D-) II ve III
...
1. <strong>Aşağıdakilerden hangisi Geometrik nesnelerin faydalarından biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi görsel bir öge <u>değildir</u>?</strong>
    - A-) Renk
    - B-) Kontrast
    - **Cevap C-) Beğeni**
    - D-) Derinlik
    - E-) Yansıma
    <hr />
1. <strong>Aşağıdakilerden hangisi kompozisyonu oluşturan ögelerden biri <u>değildir</u>?</strong>
    - A-) Hareket ve ritim
...
1. <strong>Aşağıdakilerden hangisinin alan derinliğe etkisi <u>yoktur</u>?</strong>
    ...
    - E-) Kontrast
    <hr />
1. <strong>Aşağıdakilerden hangisi görsel göstergebilimin ilgi alanına <u>girmez</u>?</strong>
    - A-) Mimari
    - B-) Karikatür
    - C-) Reklam
    - D-) Fotoğraf
    - **Cevap E-) Tiyatro**
    <hr />
1. <strong>Aşağıdakilerden hangisi simgesel göstergeye örnek <u>teşkil etmez</u>?</strong>
    - A-) Gün doğumu
    - B-) Merdiven
    - C-) Kırık testi
    - D-) Ufuk
    - **Cevap E-) Karanlık**
    <hr />
1. <strong>Perspektif katmanları arasında geçiş yapılmasını sağlayan unsur nedir?</strong>
    - A-) Hayalî çizgiler
    ...
    <hr />
## Unite 5
1. <strong>Aşağıdakilerden hangisi iletişimin amaçları arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklamcılık ile ilgili mevcut fotoğrafçılık kariyerlerindendir?</strong>
    - A-) Foto muhabiri
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklamcılığın amaçları arasında <u>yer almaz</u>?</strong>
...
1. <strong>Stok fotoğrafları nedir?</strong>
    ...
    <hr />
1. <strong>Stok fotoğrafçılığı ile ilgili aşağıdaki ifadelerden hangisi <u>yanlıştır</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi ikna kabiliyeti olan bir reklam fotoğrafını <u>tanımlamaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi yaratıcı insanların özelliklerinden biri <u>değildir</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi etkin bir reklam fotoğrafında bulunması gereken niteliklerdendir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam fotoğrafçısının yapmaması gerekenler arasında yer alır?</strong>
    - A-) Yaratıcı olmak
...
1. <strong>Başarılı reklam fotoğrafları oluşturmak ile ilgili olarak aşağıdakilerden hangisi doğrudur?</strong>
    ...
    <hr />
## Unite 6
1. <strong>Aşağıdakilerden hangisi Osman Hamdi’nin fotoğraftan yararlanarak yaptığı eseridir?</strong>
    ...
    <hr />
1. <strong>Taşınabilir fotoğraf makinesinin gelişmesi aşağıdaki hangi sanat hareketinde ortaya çıkmıştır?</strong>
    - A-) Barok
    ...
    - E-) Maniyerizm
    <hr />
1. <strong>Picasso hangi eserini, geniş açı objektiflerin yarattığı perspektif bozuklu-ğu ile yapmıştır?</strong>
    - **Cevap A-) Balıkçı**
    ...
    - E-) Armutlar ve Kadın
    <hr />
1. <strong>1918 yılında Christian Schad’ın icat ettiği fotoğraf tekniğinin adı nedir?</strong>
    - A-) Planografi
    - B-) Fototeknik
    - C-) Siyah-Beyaz
    - D-) Deklanşör
    - **Cevap E-) Schadograph**
    <hr />
1. <strong>19. Yüzyıl’da fotoğraftan yararlanarak heykel yapma Fransa'da kim tarafından icat edilmiştir?</strong>
    - A-) Heinrich Wölfflin
    - B-) M.Claudet
    - C-) Picasso
    - **Cevap D-) M.Willeme**
...
1. <strong>Fotoğraf ve heykel arasındaki ilişkiyi ilk olarak aşağıdakilerden hangisi bilimsel makale olarak yayımlamıştır?</strong>
    ...
    - E-) Salvador Dali
    <hr />
1. <strong>Küratörlüğünü Peter C. Bunnell'in yaptığı New York Modern Sanat Müzesi'nde 1970 yılında düzenlenen, fotoğraf ve heykel yöntemlerini birleştiren serginin ismi nedir?</strong>
...
1. <strong>Aşağıdakilerden hangisi planografi tekniği arasında yer alır?</strong>
    ...
    - E-) Tipografi
    <hr />
1. <strong>Fotoğraf, Ekslibris baskı çeşitleri arasında hangi simge ile ifade edilir?</strong>
    - **Cevap A-) P8**
    - B-) P6
    - C-) P7
    - D-) P5
    - E-) P4
    <hr />
1. <strong>Aşağıdakilerden hangisi Ekslibris özellikleri arasında <u>yer almaz</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi eserlerinde fotoğraftan yararlanmıştır?</strong>
    ...
    - **Cevap E-) Osman Hamdi**
    <hr />
1. <strong>17. yüzyılda hangi Hollandalı bir ressam, soyu tükenmiş didus ineptus kuşunu resmetmiştir?</strong>
    - A-) Picasso
...
1. <strong>Aşağıdakilerden hangisi son yıllarda yapılan deneysel ekslibris tasarımları arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdaki sanatçılardan hangisi tasarımlarında Ekslibris kullanmıştır?</strong>
    - A-) Fatih Aksular
    - B-) Hedieh Jafari
    - C-) Oleg Dergachov
    - D-) Ercan Tuna
...
1. <strong>Aşağıdakilerden hangisi bir tasarım disiplini olan grafik tasarımla ilgili <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi basılı medyaya yönelik grafik tasarım ürünleri arasında <u>yer almaz</u>?</strong>
    ...
    - E-) Gazete tasarımı
    <hr />
1. <strong>Işıkla yazmak anlamına gelen fotoğraf kavramı, Yunancadaki hangi iki sözcüğün birleşiminden oluşmaktadır?</strong>
    - A-) “Foto” ve “Graphy”
    - B-) “Photon” ve “Graphes”
    - C-) “Foton” ve “Graphy”
    - D-) “Photos” ve “Graphy”
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi endüstri fotoğrafçılığına geçişin sebepleri arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi fotoğrafın grafik tasarım içerisinde yer alma sebeplerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi 20. yüzyılın başında grafik tasarımı en çok etkileyen sanat hareketlerinden biri <u>değildir</u>?</strong>
    - A-) De Stijl
    - B-) Suprematizm
    - **Cevap C-) Fauvism**
    - D-) Sürrealizm
    - E-) Dada
    <hr />
1. <strong>İlk fotoğraflı afişler, 1900’lerin başlarından itibaren bazı biçimsel sanat hareketleri ile birlikte tasarlanmaya başlanmış olup, Aşağıda verilenlerden hangisi bu dönemde tasarımlarında fotoğrafı kullanan sanatçılar arasında <u>yer almaz</u>?</strong>
    ...
    - E-) Herbert Matter
    <hr />
1. <strong>Aşağıdakilerden hangisi 1950’lerde savaş sonrası refahla birlikte reklam fotoğrafçılığında geliştirilen yeni konseptin özelliklerindendir?</strong>
    ...
    <hr />
1. <strong>1960’lı yıllarda Batı Almanya’da kavramları görselleştirmek amacıyla ortaya çıkan, izleyicide şok etkisi uyandıran çarpıcı görüntülerle dikkat çekmeyi amaçlayan anlatım dili aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Foto-Grafik**
    - B-) Foto- Kübizm
    - C-) De Stijl
    - D-) Grafik Tasarım
    - E-) Foto-Tasarım
    <hr />
1. <strong>Aşağıdakilerden hangisi fotoğrafın grafik tasarımda kullanımının 1980’lerde profesyonelleşmesini tetikleyen gelişmelerin en önemlilerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi grafik tasarımda hedef kitleye mesaj aktarımında kullanılan görüntülü bilgilerden biri <u>değildir</u>?</strong>
    - A-) Sembol
    - B-) İllüstrasyon
    - C-) Tipografi
    - **Cevap D-) Fonograf**
    - E-) Fotoğraf
    <hr />
1. <strong>Aşağıdakilerden hangisi “graphishe kunst” kavramını açıklar?</strong>
    ...
    <hr />
1. <strong>Fotoğrafta ilk kez negatif-pozitif tekniğin uygulanabildiği görüntüleme tekniğinin adı aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Kalotip**
    - B-) Deguerreotype
    - C-) Helyografi
    - D-) Judea Bitümü
    - E-) Selüloit
    <hr />
1. <strong>Bir ürün ya da hizmet ile ilgili hedef kitleye iletilmek istenen mesajı metin ve görsellerle algılanabilir ve görülebilir bir düzlemde organize ederek sunan tasarım disiplini aşağıdakilerden hangisidir?</strong>
    - A-) Çevre tasarımı
    - B-) Web tasarımı
    ...
    - E-) Endüstri tasarımı
    <hr />
1. <strong>Aşağıdakilerden hangisi fotoğrafın grafik tasarımla olan ilişkisinin amaçları arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. Somut görüntünün fotoğraf kağıdında büyük bir netlikle belirlenebilmesi, sanatçıların gördükleri somut görüntüyü tuvale aktarmak yerine yeni bir görsel dil arayışı içerisine girmelerine neden olmuştur.<br /><strong>Biçimsel sanat hareketleri diye adlandırılan yeni yaklaşımların isimleri aşağıdakilerin hangisinde doğru olarak verilmiştir?</strong>
    ...
    <hr />
1. <strong>Yepyeni baskı teknikleriyle birlikte 1960’larda ortaya çıkan foto-grafik anlatım dilini çalışmalarında kullanan sanatçılar arasında aşağıdakilerden hangisi <u>yer almaz</u>?</strong>
    - A-) Holger Matthies
    ...
    - **Cevap E-) Essen Faust**
    <hr />
1. I. Dikkat çekmek<br />II. İlgi uyandırmak<br />III. Hizmet vermek<br /><strong>Hedef kitleyle iletişim kurarken grafik tasarımın hizmet ettiği amaçlar arasında yukarıdakilerden hangisi ya da hangileri yer alır?</strong>
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) Yalnız III
    - **Cevap D-) I ve II**
    ...
    <hr />
## Unite 8
1. <strong>Aşağıdakilerden hangisi afiş tasarımının amaçlarından biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi ana afiş türlerinden biridir?</strong>
    - A-) Duyuru afişi
    - B-) Sanatsal afişler
    ...
    - E-) Konser afişleri
    <hr />
1. <strong>Özel sektörde bulunan veya ticari amaç güden kuruluşların ürün servis veya hizmetlerinin ve tanıtımlarının yapılmasını sağlayan hangi afiş türüdür?</strong>
    - A-) Kültürel afişler
    - B-) Film afişleri
    - C-) Sosyal Afişler
    ...
    - E-) Sanatsal Afişler
    <hr />
1. <strong>Propaganda afişleri hangi ana afiş türündedir?</strong>
    - A-) Kültürel afişler
    - B-) Ticari Afişler
    - C-) Sanatsal Afişler
    - D-) Reklam afişleri
...
1. <strong>Aşağıdakilerden hangisi afişin temel bileşenlerindendir?</strong>
    ...
    - E-) Yazı
    <hr />
1. <strong>Tipografinin ilk amacı ve en önemli özelliği nedir?</strong>
    - A-) Dikkat çekmesi
    ...
    - E-) Tırnaklı olması
    <hr />
1. <strong>Aşağıdakilerden hangisi imge türlerinden biridir?</strong>
    - A-) Ölçü
    - B-) Renk
    - C-) Yazı tipi
    ...
    - E-) Boşluk
    <hr />
1. <strong>Foto manipülasyon nedir?</strong>
    ...
    <hr />
1. <strong>Bulunduğu dönemi anlatması bakımından diğer ögelere göre daha belirleyici bir etkiye sahip olan afişin temel bileşeni aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Renk**
    - B-) İmge
    - C-) Tipografi
    - D-) İllüstrasyon
    - E-) Yazıtipi
    <hr />
1. <strong>Tırnaklı yazıtipleri çoğunlukla nerelerde kullanılır?</strong>
    ...
    <hr />
1. <strong>Konferans, seminer, sinema, tiyatro, konser ve sergi gibi kültürel aktiviteler hakkında duyurulması gerekenlerin; fotoğraf, illüstrasyon ve tipografi kullanılarak tasarlandığı afişlere ne ad verilir?</strong>
    - A-) Sergi Afişi
    - B-) Sanatsal Afişler
    - C-) Ticari Afişler
    - D-) Sosyal Afişler
...
1. <strong>Yazı tiplerinin tasnifi aşağıdakilerden hangisidir?</strong>
    ...
    - E-) İnce-kalın
    <hr />
1. I. Dikkat çekmesi<br />II. Göze hitap etmesi<br />III. Tasarımda ahengin sağlanması<br /><strong>Yukarıdakilerden hangisi ya da hangileri afişte renk kullanımının sağladığı avantajlar arasında yer alır?</strong>
    - A-) Yalnız I
    - B-) Yalnız III
    - C-) I ve II
    - D-) I ve III
    ...
    <hr />
## Unite 9
1. <strong>Aşağıdakilerden hangisi görüntü işleme işlemlerinden biri <u>sayılamaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi görüntü işleme için kullanılabilecek tanımlardan biridir?</strong>
    ...
    <hr />
1. <strong>Aşağıdaki hangi seçenekte yazılımların taban kombinasyonu doğru verilmiştir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi Adobe Photoshop yazılımına çalışma alanı için belirlenen renk profillerinden biridir?</strong>
    - A-) GMK
    - **Cevap B-) CMYK**
    - C-) RGD
    - D-) S-TGB
    - E-) C-CMYK
    <hr />
1. <strong>Aşağıdakilerden hangisi Adobe Photoshop yazılımı ile <u>gerçekleştirilemez</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi bir dosya formatı <u>değildir</u>?</strong>
    ...
    - E-) .PSB
    <hr />
1. <strong>Aşağıdakilerden hangisi araç çubuğunda yer alan bir araçtır?</strong>
...
1. <strong>Aşağıdakilerden hangisi katman panelinde <u>yer almaz</u>?</strong>
    ...
    - E-) Katman kilitleme
    <hr />
1. <strong>Aşağıdaki işlevlerden hangisi filtreler menüsünde <u>yer almaz</u>?</strong>
    - A-) Bulanıklaştırma
    - B-) Keskinleştirme
    - C-) Stilize etme
    ...
    - E-) Işık efektleri
    <hr />
1. <strong>Aşağıdakilerden hangisi görüntü işleme ile ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi Adobe Photoshop ve Adobe Illustrator yazılımlarının kullanımı için gerekli olan uygulamadır?</strong>
    - A-) GIMP
    - B-) Photo Identier
...
1. <strong>Vektörel tabanlı yazılımlar hakkında aşağıdaki ifadelerden hangisi doğrudur?</strong>
    ...
    <hr />
1. <strong>Aşağıdaki işlemlerden hangisi katman stil menüsünde yer alır?</strong>
    ...
    <hr />
## Unite 10
1. <strong>Aşağıdakilerden hangisi endüstriyel tasarımın tanımıdır?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi endüstriyel tasarımın ürün aracılığı ile pazarda rakiplere karşı sağladığı bir üstünlük <u>değildir</u>?</strong>
    ...
    - E-) Stil
    <hr />
1. <strong>Aşağıdakilerden hangisi endüstriyel tasarımın bir adımı <u>değildir</u>?</strong>
...
1. <strong>Fotoğrafın tasarım adımlarında kullanımıyla ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi ürün tanıtımında etkili olan fotoğrafların özelliklerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Fotoğrafın basılarak kullanıldığı özelleşmiş ürünlerde fotoğrafın ana işlevi aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>Fotoğrafçılıkta ihtiyaç duyulan en temel 2 modül nedir?</strong>
...
1. <strong>Fotoğraf makinelerinde kullanıcı ile etkileşimde bulunacak kısım nedir?</strong>
    ...
    - E-) Mekanizma
    <hr />
1. <strong>Aşağıdakilerden hangisi objektifin ışığı kontrol eden özelliklerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Mekanizma modülü tasarımsal açıdan daha çok ne ile ilişkilidir?</strong>
    - A-) Fizik bilimi
    - B-) Kimya bilimi
    - C-) Mekanik tasarım
    - D-) Sanatsal tasarımı
...
1. <strong>Moda fotoğrafının tanımı aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>Moda fotoğrafı dünyada ilk olarak günümüzde de modanın başkenti olarak bilinen hangi şehirde ortaya çıkmıştır?</strong>
    - A-) Roma
    - B-) Londra
    - C-) Newyork
    - **Cevap D-) Paris**
    - E-) Milano
    <hr />
1. <strong>Dünyada İlk moda fotoğrafı olarak sayılan Fransız soylularından, Kontes de Castiglione’nin gardrobunu tanıtan fotoğrafçı asağıdakilerden hangisidir?</strong>
    ...
    - E-) Lee Miller
    <hr />
1. <strong>Fotoğrafta kullanılan dikey çizgiler hangi kavram-kavramların etkisini arttırmaktadır?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi bir fotoğraf çekiminde komposizyona etki eden ışığın yönlerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Bir moda fotoğraf çekimi sırasında alan kullanımında ana objenin ya da objelerin olduğu, kompozisyonun öne çıkan kısmı ne olarak adlandırılmaktadır?</strong>
    ...
    - E-) Eksik Alan
    <hr />
1. <strong>Renkler, insanlar üzerinde oluşturdukları etkilerine tanımlandığına göre, mavi renk tonları nasıl renkler olarak adlandırılmaktadır?</strong>
    - A-) Sıcak renkler
    - B-) Kontrast renkler
    ...
    - E-) Nötr renkler
    <hr />
1. <strong>Aşağıdakilerden hangisi fotoğraf çekimlerinde stüdyoda kullanılan teknik ekipmanlardan biri <u>değildir</u>?</strong>
    - A-) Şemsiyeler
...
1. <strong>Moda reklam fotoğraflarının ana amacı nedir?</strong>
    ...
    <hr />
1. <strong>Moda Fotoğrafında Modernizm'in öncüsü ve “New Objektivity” kavramını ortaya koyan aşağıdakilerden hangisidir?</strong>
    - A-) Adolf de Mayer
    ...
    - E-) Lee Miller
    <hr />
1. <strong>Aşağıdakilerden hangisi iyi bir moda fotoğrafçısının özelliklerinden biri <u>değildir</u>?</strong>
...
1. <strong>Aşağıdakilerden hangileri yapay ışık kaynaklarından biri <u>değildir</u>?</strong>
    ...
    <hr />
## Unite 12
1. <strong>Aşağıdakilerden hangisi yapısal ögeler içerisinde yer alır?</strong>
    - A-) Işık
    - B-) Keskinlik
    - C-) İlgi merkezi
    - **Cevap D-) Boşluk**
    - E-) Belirginlik
    <hr />
1. <strong>Parçaların ve tekrarların gözün takibiyle tamamlanarak sonucu veya bütününü oluşturması fotoğrafta Gestalt Algısı'na göre nasıl ifade edilmektedir?</strong>
    - A-) Perspektif
    - **Cevap B-) Tamamlama**
    ...
    - E-) Benzerlik
    <hr />
1. <strong>Fotoğraflanacak bir mimari unsur veya cadde görüntüsünde dikkat edilecek en önemli unsur aşağıdakilerden hangisidir? </strong>
    - A-) Doku
    - B-) Espas
    - C-) Işık
    - **Cevap D-) Perspektif**
    - E-) Renk
    <hr />
1. <strong>Aşağıdakilerden hangisi fotoğrafta kompozisyonun yapısal ögelerinden biridir?</strong>
    - A-) Perspektif
    - B-) İlgi Merkezi
    - C-) Keskinlik
    - D-) Bakış Açısı
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi, fotoğrafik bir kompozisyon öğesidir?</strong>
    - A-) Leke
    - B-) Doku
    - **Cevap C-) Perspektif**
    - D-) Sadelik
    - E-) Keskinlik
    <hr />
1. <strong>Seçeneklerden hangi Gestalt kuramı ilkesi, parçaların ve tekrarların gözün takibiyle tamamlanarak sonucu veya bütünü oluşturması özelliğini barındırır?</strong>
    - **Cevap A-) Tamamlama**
    ...
    - E-) Simetri
    <hr />
1. <strong>Fotoğrafın temsil özelliği en çok hangi işe yaramaktadır?</strong>
    ...
    <hr />
1. <strong>Frank Lloyd Wright’ın Falling Water House yapısına ait ikonik fotoğraf kim tarafından çekilmiştir?</strong>
    ...
    - E-) Pierre Koenig
    <hr />
1. <strong>Camera Obscura ilk olarak hangi yüzyılda kullanılmaya başlamıştır?</strong>
    - A-) 15. yüzyıl
    - B-) 19. yüzyıl
    - C-) 20. yüzyıl
    - **Cevap D-) 17. yüzyıl**
    - E-) 18. yüzyıl
    <hr />
1. <strong>Algı türleri arasında aşağıdakilerden hangisi en etkilidir?</strong>
    - A-) Dokunsal Algı
    - B-) İşitsel Algı
    - C-) Koku Algısı
    - **Cevap D-) Görsel Algı**
    - E-) Tat Algısı
    <hr />
1. <strong>Aşağıdakilerden hangisi mekânın temsilinin önemini <u>vurgulamamaktadır</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi mekânın görsel algısını etkileyen tasarım unsurlarından biri <u>değildir</u>?</strong>
    - A-) Biçim
    - B-) Işık
    - C-) Renk
    - D-) Malzeme
    - **Cevap E-) Koku**
    <hr />
1. <strong>Kendi tasarımlarını çekmeden önce kurgulayan mimar </strong><strong>aşağıdakilerden hangisidir</strong><strong>?</strong>
    - A-) Pierre Jeanneret
    - B-) Oscar Niemeyer
    ...
    <hr />
1. <strong>Mekândaki işitsel yansıma aşağıdakilerden hangisi ile çözülür?</strong>
    ...
    <hr />
1. <strong>‘’Vietnamlı Çocuk’’ fotoğrafı kime aittir?</strong>
...
1. <strong>Aşağıdakilerden hangisi seramik malzemenin kullanıldığı alanlardan <u>değildir</u>?</strong>
    ...
    - E-) Sanat
    <hr />
1. <strong>Aşağıdakilerden hangisi ham hâldeki seramik yüzeyler üzerinde <u>uygulanamaz</u>?</strong>
    ...
    <hr />
1. <strong>Serigrafi Aktarım Yöntemi'nde kaliteli fotografik etki elde etmek için tram değeri ne olmalıdır?</strong>
    - A-) 300dpi=33tram
    - B-) 1024dpi=102tram
    - C-) 500dpi=57tram
    ...
    - E-) 850dpi=44tram
    <hr />
1. <strong>Serigrafi aktarım yönteminde baskıya hazırlanan görselin renk modu aşağıdakilerden hangisidir?</strong>
    - A-) LAB
    - B-) Grayscale
    - C-) Index
    - D-) RGB
    - **Cevap E-) CMYK**
    <hr />
1. <strong>Bisküvi haldeki seramik bünye üzerine dekal ile aktarım işlemi yapıldığında aşağıdakilerden hangisi ile sabitleme yapılmalıdır?</strong>
    - A-) Cilalama
    ...
    - E-) Taşlama
    <hr />
1. <strong>Sırüstü dekal-çıkartma uygulaması yapılırken kullanılan boya aşağıdakilerden hangisidir?</strong>
    - A-) CMC
    - B-) Toner mürekkebi
    ...
    - E-) Sıraltı boya
    <hr />
1. <strong>Lazer-fotokopi aktarım yönteminde kullanılan CMC, baskısı alınan kâğıdın hangi yüzeyine tutunur?</strong>
    - A-) Kırmızı
    - B-) Siyah
    - **Cevap C-) Beyaz**
    - D-) Oksitli
    - E-) Aharlı
    <hr />
1. <strong>Toner aktarım yönteminde, çıktı-fotokopi alınan makinenin toner içeriğinde aşağıdakilerden hangisi bulunmalıdır?</strong>
    - A-) Oksalik asit
    - B-) Bakır oksit
    - C-) Sıraltı boya
    - D-) Amonyum dikromat
    - **Cevap E-) Demir oksit**
    <hr />
1. <strong>Toner aktarım yönteminde aşağıdakilerden hangisi yapılmadığında aktarım işlemi <u>gerçekleşmez</u>?</strong>
    ...
    - E-) Pozlama yapılması
    <hr />
1. <strong>Cyanotype aktarım yönteminde bisküvi seramik yüzeye pozlama yapılabilmesi için öncesinde aşağıdakilerden hangisini yapmak gerekir?</strong>
...
1. <strong>Sanat eserlerinde fotoğrafın kullanma şekli hangisinde yanlış verilmiştir?</strong>
    ...
    - E-) Objenin yüzeyinde
    <hr />
1. <strong>"Küresel köy" kavramını kullanan düşünür aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) McLuhan**
    - B-) Danto
    - C-) Boltanski
    - D-) Sherman
...
1. <strong>Berlin Duvarı imgesini ipliklerle pikselleştiren Diane Meyer'in vurguladığı kavram hangisidir?</strong>
    ...
    - E-) Anıt resim
    <hr />
1. <strong>Dönemin ikonik kişilerin portre serilerini yapan sanatçı kimdir?</strong>
    - A-) Kandinsky
    - B-) Pinky MM/Bass
    - C-) MannyRobertson
    - **Cevap D-) Andy Warhol**
    - E-) Shaun Kardinal
    <hr />
1. <strong>Çağdaş sanat eserlerine katılan fotoğraflarını fiziksel olarak sağlama kaynakları arasında yer almayan aşağıdakilerden hangisidir?</strong>
    - A-) Aile albümleri
    ...
    <hr />
1. <strong>"Kendine mal etme" stratejisinin sanatında önemli bir yeri olan sanatçı kimdir?</strong>
    ...
    <hr />
1. <strong>"Fotoğraf en mükemmel resimdir. Değişmez mutlaktır ve dolayısıyla özerktir, koşulsuzdur, üsluptan yoksundur." ifadesi aşağıdakilerden hangisine aittir?</strong>
    - A-) Rauchenberg
    - B-) Perra
    - **Cevap C-) Richter**
    - D-) Zexter
    - E-) Cata
    <hr />
1. <strong>Pinhole fotoğrafçılığın özellikleri arasında hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>Sanat projesinde portreleri avuç içlerine iplikle işleyen ve hayatına iz bırakanları fiziksel acıyla bağdaştıran sanatçı hangisidir?</strong>
    - A-) Elise Wehle
    - B-) Diane Meyer
    - C-) Cecile Perra
    - D-) Yoon Ji Seon
    - **Cevap E-) David Cata**
    <hr />
1. <strong>Eselerinde özlem hissini fotoğraf ve sulu boyayı birlikte kullanan sanatçı kimdir?</strong>
    - A-) CindySherman
    - **Cevap B-) AlizaRazell**
    - C-) SherieLevine
    - D-) Lisa Kokin
    - E-) Melisa Zexter.
    <hr />
1. <strong>"Çağdaş sanat "havasını soluduğumuz ve hakkında bir söyleme yetkimizin olduğu bir zamanı ifade eder." fikrini paylaşan kimdir?</strong>
    - A-) Danto
    - **Cevap B-) Eroğlu**
    - C-) Marshall
    - D-) Engin
    - E-) Maleviç
    <hr />
1. <strong>Fotoğrafın özellikleri ile ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>PopArt temsilcileri olan sanatçıların doğru eşleştirilmesi aşağıdakilerden hangisidir?</strong>
