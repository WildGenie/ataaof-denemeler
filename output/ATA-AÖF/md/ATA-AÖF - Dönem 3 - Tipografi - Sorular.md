# Tipografi (Dönem 3) - Tüm Sorular

## Unite 1
1. **Aşağıdakilerden hangisi yazının ortaya çıkma nedenlerinden biri olabilir?**
    ...
    - E-) Şiir yazma
    <hr />
1. **Aşağıdakilerden hangisi modern dünyada halen kullanılmakta olan logografik bir yazı sistemidir?**
    - A-) Kiril Alfabesi
    ...
    - **Cevap E-) Çin yazısı**
    <hr />
1. **Aram, İbrani (Hibro) ve Arap yazılarının ortak özelliği aşağıdakilerden hangisidir?**
...
1. **Fonem (ses birim) nedir?**
    ...
    <hr />
1. **Dünya üzerinde ortaya çıktığı bilinen en eski yazı sistemi aşağıdakilerden hangisidir?**
    - A-) Brahmi Yazısı
    - B-) Çin Yazısı
    - C-) Latin Alfabesi
    - **Cevap D-) Çivi Yazısı**
    - E-) Mısır Yazısı
    <hr />
1. **Aşağıdakilerden hangisi Mısır yazısı örneklerinden birinin isimi değildir?**
    - **Cevap A-) Brahmi**
    - B-) Hiyeroglif
    - C-) Hiyeratik
    - D-) Demotik
    - E-) Papaz yazısı
    <hr />
1. **İlk alfabe hangi medeniyet tarafından geliştirilmiştir?**
    - A-) Çin
    - B-) Mısır
    - C-) Girit
    - **Cevap D-) Fenike**
    - E-) Olmek
    <hr />
1. **Arap yazısının farklı coğrafyalarda kullanım alanı bulmasının temel nedeni aşağıdakilerden hangisidir?**
    ...
    <hr />
1. **Girit Medeniyeti tarafından geliştirilen Avrupa’nın en eski yazı sistemine ne ad verilir?**
    - A-) Kıbrıs yazısı
    ...
    - E-) Etrüsk yazısı
    <hr />
1. **Aşağıdaki medeniyetlerden hangisi Orta Amerika yazılarını kullanmamıştır?**
    - A-) Olmek
    - B-) Aztek
    - C-) Maya
    - **Cevap D-) Asur**
    - E-) Zapotek
    <hr />
1. **Sözcükleri görünür kılarak dili görsel veya dokunsal olarak temsil eden araç aşağıdakilerden hangisidir?**
    - A-) Fotoğraf
    - **Cevap B-) Yazı**
    - C-) Baskı
    - D-) Grafik
    - E-) Renk
    <hr />
1. **Üçgen uçlu bir milin kil yüzeyine bastırılmasıyla elde edilen çizgisel, düz yarıklar şeklindeki izlerden meydana gelen yazı sistemi aşağıdakilerden hangisidir?**
    - A-) Kıbrıs Yazısı
    - B-) Girit Yazısı
    - C-) Brahmi
    - D-) Mısır Yazısı
    - **Cevap E-) Çivi Yazısı**
    <hr />
1. **İki karakterin birlikte tasarlanmış şekli olan ve ilk örnekleri yaklaşık MS 45’te hızla yazılan yazılarda ve kısatmalarda kullanılan yazı türü aşağıdakilerden hangisidir?**
    - **Cevap A-) Ampersand**
    - B-) Hiyeroglif
    - C-) Hiyeratik
    - D-) Demotik
...
1. **Aşağıdakilerden hangisi ailelere göre yazı sistemlerinden biri değildir?**
    ...
    - E-) Çin Yazısı
    <hr />
1. **Üçgen uçlu bir milin kil yüzeyine bastırılmasıyla elde edilen çizgisel, düz yarıklar şeklindeki izlerden oluşan yazı sistemi aşağıdakilerden hangisidir?**
    - A-) Mısır yazısı
    - **Cevap B-) Çivi yazısı**
    - C-) Brahmi
    - D-) İndus yazısı
    - E-) Girit yazısı
    <hr />
1. **Sümer çivi yazısı ile kaydedilen, dünyanın ilk edebî metni aşağıdakilerden hangisidir?**
    ...
    - E-) Türeyiş Destanı
    <hr />
1. **Dilin en küçük yapı taşına ne ad verilir?**
    - A-) Piktogram
    - B-) Syllabic
    - C-) Consonantal
    - D-) Segmental
    - **Cevap E-) Fonem**
    <hr />
1. **Aşağıdakilerden hangisi yazının ilk ortaya çıktığı dönemlerde kullanım alanlarından biridir?**
    - A-) Gezi rehberleri
...
1. **Hiyeroglifler ile ilgili olarak a****şağıdakilerden hangisi** **yanlıştır?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi Proto Sinai (Erken Sina) yazısının özelliklerinden biridir?**
    ...
    <hr />
1. **Ortaya çıktığı bölgeye özgü tek ve en eski yazı sistemi olduğu gibi dünyanın en uzun süre kesintisiz kullanılan yazı sistemi aşağıdakilerden hangisidir?**
    - A-) Çivi yazısı
    - B-) Mısır yazısı
    - **Cevap C-) Çin yazısı**
    - D-) Brahmi yazısı
    ...
    <hr />
## Unite 2
1. **İlk alfabe örneğini oluşturan medeniyet aşağıdakilerden hangisidir?**
    - A-) Yunan
    - **Cevap B-) Fenike**
    - C-) Asur
    - D-) Çin
    - E-) İndus
    <hr />
1. **Aşağıdakilerden hangisi Bustrofedon yazısının tanımıdır?**
    ...
    <hr />
1. **Romen rakamlarının hesaplamalarda kullanılmama nedeni nedir?**
    ...
    <hr />
1. **Anadolu’da hayvan derisinden imal edilen taşıyıcı yüzeye ne ad verilir?**
    - A-) Kil tablet
    - B-) İncunable
    - C-) Papirüs
    - D-) Kâğıt
    - **Cevap E-) Parşömen**
    <hr />
1. **Aşağıdakilerden hangisi papirüse kıyasla parşömenin özelliklerinden biri değildir?**
    - A-) Dayanıklıdır
    - B-) Ekonomiktir
    - C-) Pürüzsüzdür
    ...
    <hr />
1. **MS 114’e tarihlendirilen Trajan Sütunu’nda yer alan kitabede kullanılan harfler hangi yazının en iyi örneği olarak kabul edilir?**
...
1. **“Kursiv” ne anlama gelir?**
    ...
    <hr />
1. **Erken dönem elyazmalarındaki harfleri bir “uncial” veya bir Roma inçi yüksekliğinde olan ve kare kapital ve rustik harflerden çok daha hızlı ve kolay yazılabilen yuvarlak majüskül harflerden oluşun yazı stiline ne ad verilir?**
    - A-) Gotik
    - B-) Majüskül
    ...
    - E-) Merovenj
    <hr />
1. **Roma’nın çöküşünün ardından Batı Avrupa’nın tümünde kullanılması hedeflenen ilk ortak yazı stiline ne ad verilir?**
    ...
    - E-) Gotik yazı
    <hr />
1. **Hristiyanlığın 4. ve 9. yüzyıllar arasındaki tarihlerinde kullanılması nedeniyle “kilise harfleri” olarak da adlandırılan stiller hangileridir?**
    - A-) Gotik ve hümanist
    ...
    <hr />
1. **Roma’nın çöküşünün ardından Batı Avrupa’nın tümünde kullanılması hedeflenen ilk ortak yazı stili aşağıdakilerden hangisidir?**
    ...
    - E-) Runik alfabe
    <hr />
1. **İlk örnekleri MÖ 3. yüzyılın başlarında Yunanlılar tarafından tercih edilen, yuvarlak majüskül harflerden oluşan harf stili aşağıdakilerden hangisidir?**
    - A-) Runik alfabe
    - **Cevap B-) Uncialler**
...
1. **Aşağıdakilerden hangisi Roma El Yazısı harflerinden biri değildir?**
    ...
    - **Cevap E-) Frenk Stili**
    <hr />
1. **Kesik uçla veya kaz tüyü kalemle yazılan ve ilk örnekleri IV. yüzyılda Roma el yazmalarında görülen yazı örneği aşağıdakilerden hangisidir?**
...
1. I. İrlanda veya Anglo-Sakson stili<br />II. Merovenj ve Doğu Frenk stili<br />III. Lombardik ve Vizigot stili<br />**Yukarıdaki ifadelerden hagisi ya da hangileri ulusal el yazısı stillerindendir?**
    ...
    - E-) I ve III
    <hr />
1. **Parşömenlerden katlanarak oluşturulan ve bugün kullanılan basılı kitapların ilk hâline ne ad verilir?**
    - A-) Majüskül
    - B-) Uncial
    - C-) Gotik
    - **Cevap D-) Kodeks**
    - E-) İndus
    <hr />
1. **Anadolu’da hayvan derisinden imal edilen parşömen hangi yazının gelişimine katkıda bulunmuştur?**
    - **Cevap A-) Latin**
    - B-) Romen
    - C-) İrlanda
    - D-) Asur
...
1. **Aşağıdakilerden hangisi hızlı ve kolay yazılabilen yuvarlak majüskül harflerdir?**
    ...
    - E-) Anglo-Sakson stili
    <hr />
1. **Harflerin kesik uçla veya kaz tüyü kalemle yazılmasıyla oluşturulan Roma el yazması aşağıdakilerden hangisidir?**
    - A-) Rustik yazı
    - B-) Yarı-Uncialler
    - C-) Runik alfabe
    - D-) Çin
    ...
    <hr />
1. **Bugün Latin alfabesi sisteminde kullanılan soldan sağa okuma yönü hangi medeniyet tarafından belirlenmiştir?**
    - A-) Mısır
    - B-) Fenike
    - C-) Girit
    - D-) Kıbrıs
    - **Cevap E-) Yunan**
    <hr />
1. **Aşağıdakilerden hangisi rulolar hâlinde saklanan papirüslere verilen isimlerden biri değildir?**
    - A-) Tomar
    - B-) Volume
    - **Cevap C-) Parşömen**
    - D-) Volumen
    - E-) Scroll
    <hr />
1. **Aşağıdakilerden hangisi 114’e tarihlendirilen Trajan Sütunu’nda yer alan kitabede kullanılan harflerin özelliklerinden biri değildir?**
    - A-) Seriflidir.
    ...
    <hr />
1. **7. yüzyılın sonlarına doğru Frenklerin ulusal yazı stili olan Merovenj yazı stili hakkındaki ifadelerden hangisi doğrudur?**
    ...
    <hr />
1. **Roma kapital harflerin kesik uçlu kamış veya kaz tüyü kalemin kullanımı ile ortaya çıkan çeşitlemelerine ne ad verilir?**
    - A-) Hümanist yazı
    ...
    - E-) Anglo-Sakson stili
    <hr />
1. **Runik alfabe ile ilgili olarak aşağıdakilerden hangisi doğrudur?**
    ...
    <hr />
## Unite 3
1. **Çin’de ve Kore’de hareketli harf kalıplarından yararlanılarak çeşitli metinlerin baskılarının yapıldığı bilinmektedir. Bu amaçla kullanılan ilk malzeme aşağıdakilerden hangisidir?**
    - A-) Porselen
    - B-) Metal
    - **Cevap C-) Ahşap**
    - D-) Çinko
    - E-) Pişmiş kil
    <hr />
1. **Dünyada, hareketli metal kalıplar kullanılarak basıldığı bilinen en eski kitap aşağıdakilerden hangisidir?**
    - A-) Tevrat
    - B-) İncil
    - C-) Zebur
    - **Cevap D-) Jikji**
    - E-) Gutenberg İncili
    <hr />
1. **Her bir karakterin tek tek tasarlanarak istenilen ölçüde bir kalıba dönüşecek şekilde metalden dökülmesi ve bu kalıpların satırlar, paragraflar ve sayfalar oluşturacak şekilde yan yana getirilerek baskı kalıbının oluşturulması prensibine dayalı yüksek baskı tekniği ne ad verilir?**
    - A-) Gravür
    - B-) Rölyef
    - C-) Ofset
    - D-) Serigrafi
...
1. **Aşağıdakilerden hangisi Gotik stilin belirgin özelliklerinden biri değildir?**
    ...
    <hr />
1. **Öncüsü Karolenj minüskül ile kıyaslandığında daha basık; yuvarlak ve açık renkli, alt ve üst uzantıları uzun olabilirken harflerin x-yükseklikleri kısaldığı için “Roman” harfler, olduğundan daha küçük boyutlu ve zayıf algılanan ve Avrupa’da yaygın olarak kullanılan yazı stiline ne ad verilir?**
    - A-) Rustik yazı
    - B-) Gotik yazı
    ...
    - E-) İtalik yazı
    <hr />
1. **Bugün bildiğimiz anlamıyla kâğıt ilk olarak nerede üretilmiştir?**
    - A-) Semerkand
    - B-) Japonya
    - C-) Moğolistan
    - D-) Kanada
    - **Cevap E-) Çin**
    <hr />
1. **Aşağıdakilerden hangisi Johannes Gutenberg’in 42 Satırlık İncil’in baskısının özelliklerinden biri değildir?**
    ...
    <hr />
1. **“Uppercase” (üst kasa) ve“lowercase” (alt kasa) terimleri için aşağıdaki açıklamalardan hangisi söylenemez?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi metal harf kalıplarının bölümlerinden biri değildir?**
    - **Cevap A-) Hurufat**
    - B-) Yüz
    - C-) Gövde
    - D-) Ayaklar
    - E-) Kertik
    <hr />
1. **Erken dönem baskı harflerinden matbaa öncesi ilk minüskül harfleri aşağıdakilerden hangisidir?**
    ...
    - E-) Çivi Yazısı
    <hr />
1. **Metal harf kalıpları kullanılarak uygulanan yüksek baskı tekniği “letterpress” ile oluşturulan baskıya ne ad verilir?**
    - A-) Serigrafi
    - **Cevap B-) Tipo Baskı**
    - C-) Düz Baskı
    - D-) Şablon Baskı
    - E-) Gravür
    <hr />
1. **14. yüzyılda Almanya’da “Textur”, Fransa’da “lettre de forme” ve İngiltere’de “blackletter” olarak adlandırılan yazı türü aşağıdakilerden hangisidir?**
    - A-) Çivi yazısı
    - B-) İtalik yazı
    - C-) Hümanist yazı
    - D-) Mısır yazısı
    - **Cevap E-) Gotik yazı**
    <hr />
1. **15. yüzyılda Avrupa’da bilinen ilk tahta baskılara ve hediyelik eşyalara ne ad verilir?**
    - A-) Ksilografi
    - B-) Punch
    - C-) Hurufat
    - **Cevap D-) Helgen**
    - E-) Harf Kasası
    <hr />
1. **14. yüzyılda Almanya’da “Textur”, Fransa’da “lettre de forme” ve İngiltere’de “blackletter” olarak adlandırılan yazı aşağıdakilerden hangisidir?**
    - **Cevap A-) Gotik**
    - B-) Rustik
    - C-) Latin
    - D-) Mısır
    - E-) Hümanist Yazı
    <hr />
1. **Tipografik elemanlar arasında kullanılan boşluklara ne ad verilir?**
    - A-) Eksen (Axis)
    - B-) Dökümhane (Foundry)
    - **Cevap C-) Espas (Space)**
    - D-) Çengel (Cedilla)
    - E-) Cetvel (Rule)
    <hr />
1. **Dinî hediyelik eşyalar olarak kullanılan, Avrupa’da bilinen ilk tahta baskılara ne ad verilir?**
    - A-) Jikji
    - B-) Gravür
    - C-) Tipo
    - **Cevap D-) Helgen**
    - E-) Rölyef
    <hr />
1. **Aşağıdakilerden hangisi Gutenberg Matbaası öncesinde metin basımında kullanılan hareketli kalıpların malzemelerden biri değildir?**
    - A-) Pişmiş toprak
    - B-) Metal
    - C-) Ahşap
    - **Cevap D-) Cam**
    - E-) Porselen
    <hr />
1. **Tipo baskı tekniği ile ilgili olarak aşağıdakilerden hangisi yanlıştır?**
    ...
    <hr />
1. **Günümüze ulaşan en eski basılı kitap aşağıdakilerden hangisidir?**
    - A-) Jikji
    - B-) 42 Satırlık İncil
    - C-) İncunabulum
    - **Cevap D-) Elmas Sutra**
    ...
    <hr />
## Unite 4
1. **Venedik’te, Karolenj minüskül harflerinden etkilenerek daha yuvarlak, majüskül ve minüskül harf ayrımının daha belirgin olduğu Roman harf biçimlerine ne ad verilir?**
    - A-) Gotik
    - **Cevap B-) Majiskül**
    - C-) Roman kapital
    - D-) Hümanist
    - E-) Rustik
    <hr />
1. **Nicolas Jenson tarafından 1476’da dökümü gerçekleştirilen ilk Roman yazı karakterlerinin kaynağı, kökeni aşağıdakilerden hangisidir?**
    - A-) Hümanist yazı
    - B-) Gotik yazı
    ...
    - E-) Kursiv
    <hr />
1. **“Plain” veya “Regular” olarak da adlandırılan bir yazı karakteri ailesinin en standart, en sade çeşidine ne ad verilir?**
    - A-) Kursiv
    - B-) Minüskül
    - C-) Descender
    - D-) Hümanist
    - **Cevap E-) Roman**
    <hr />
1. **İtalik harfler nerede ortaya çıkmıştır?**
    - A-) Almanya
    - B-) İngilitere
    - **Cevap C-) İtalya**
    - D-) Hollanda
    - E-) Fransa
    <hr />
1. **Aşağıdakilerden hangisi italik harflerin özelliklerinden değildir?**
    ...
    <hr />
1. **“Uppercase” (üst çekmece) ve “lowercase” (alt çekmece) terimleri hangi harfler için kullanılır?**
    ...
    <hr />
1. **Yazı boyutunu tanımlamada tutarlı bir dil oluşturmaya yönelik olarak Avrupa’da yaygınlaşan ölçü sistemi aşağıdakilerden hangisidir?**
    - A-) Lowercase
    - B-) Milimetre
    - C-) Primer
    - **Cevap D-) Punto**
    - E-) İnç (inch)
    <hr />
1. **Aşağıdaki ifadelerden hangisi “Roman du Roi” yazı karakteri için yanlıştır?**
    ...
    <hr />
1. **Aşağıdaki tipograflardan hangisinin yazı karakteri tasarımları transitional dönem (geçiş dönemi) karakterleri arasında yer alır?**
    ...
    - E-) Firmin Didot
    <hr />
1. **Tarihte ilk hareketli metal harfler kullanılarak 42 Satırlık İncil’in basımının gerçekleştirilmesiyle yazının tarihinde eşi görülmemiş bir dönüm noktası yaşatan matbaacı aşağıdakilerden hangisidir?**
    - **Cevap A-) Gutenberg**
    - B-) Nicodimus Metaxas
    - C-) Albrecht Pfister
    - D-) Erich Walbaum
    - E-) William Caslon
    <hr />
1. **“Plain” veya “Regular” olarak da adlandırılan ve bir yazı karakteri ailesinin en standart, en sade çeşidi olan yazı karakteri aşağıdakilerden hangisidir?**
    - A-) İtalik
    - **Cevap B-) Roman**
    - C-) Gotik
    - D-) Grafitti
    - E-) Caslon
    <hr />
1. **1529 yılında harflerin anatomileri ile insan anatomisi arasında bağ kuran bir dizi diyagram basan ressam ve tipograf aşağıdakilerden hangisidir?**
    ...
    - E-) Baskerville
    <hr />
1. **Gündelik, sağa yatık bir el yazısı tipi olan italik harfler ilk nerede ortaya çıkmıştır?**
    - A-) Almanya
    - B-) İngiltere
    - C-) Fransa
    - **Cevap D-) İtalya**
    - E-) Hollanda
    <hr />
1. **Aşağıdakilerden hangisi Fransa saray matbaasında kullanılmak üzere tasarlanmış olması nedeniyle ilk kurumsal yazı karakterlerinden biridir?**
    ...
    - E-) Majiskül
    <hr />
1. **Antik kökenli harflerin metal dökümünü gerçekleştiren ilk Roman yazı karakterleri kim tarafından tasarlanmıştır?**
    - A-) William Caslon
    - B-) Aldus Manutius
    - C-) Erich Walbaum
    - D-) Giambattista Bodoni
    ...
    <hr />
1. **Roman du Roi gibi bir grid sistemi temel alınarak tasarlanan yazı karakteri aşağıdakilerden hangisidir?**
    - A-) Minüskül
    - B-) Hümanist
    - C-) Karolenj
    - **Cevap D-) Champfleury**
    - E-) Antikite
    <hr />
1. **Aşağıdakilerden hangisi Roman karakterler için söylenemez?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi italik harflerin kullanım amaçları arasında yer almaz?**
    ...
    <hr />
## Unite 5
1. **Aşağıdakilerden hangisi Sanayi Devrimi’nin tipografiyi etkileyen sonuçlarından biri değildir?**
    ...
    <hr />
1. **Fat Face yazı karakterlerinin tümüne verilen genel isim aşağıdakilerden hangisidir?**
    - A-) Grotesk
    - B-) Gotik
    - **Cevap C-) Slab Serif**
    - D-) Batone
    - E-) Helvetica
    <hr />
1. **Aşağıdakilerden hangisi Sanayi Devrimi sonrası harf kalıplarında ahşabın kullanılmasının nedenlerinden biridir?**
...
1. **Aşağıdakilerden hangisi Clarendonların özelliklerinden biri değildir?**
    ...
    <hr />
1. **Monotype makinesinin linotype makinesinden temel farkı nedir?**
    ...
    <hr />
1. **Pantograf kullanılarak tek bir çizim setinden yola çıkılarak çeşitli boyutlarda kalıpların dökülebilmesinin yarattığı dezavantaj nedir?**
    ...
    <hr />
1. **Litografi tekniğinin gazete ve dergilerde tercih edilmiş olmasının temel sebebi nedir?**
    ...
    <hr />
1. **Seçilen karakterlerin içinden ışığın geçebildiği negatif bir matris üzerine tutularak fotoğrafik kâğıda pozlanırken bir mercek aracılığı ile gerektiği kadar büyütülüp küçültülebilen dizgi sistemi aşağıdakilerden hangisidir?**
    - A-) Sıcak dizgi
    - B-) Linotype
    - C-) Tipo baskı
    - D-) Monotype
    - **Cevap E-) Fotodizgi**
    <hr />
1. **Fotodizgi tekniği için tasarlanan yazı karakterlerinin noktaları büyütülürken harflerin iç boşluklarını sınırlayan çizgilerin inceltilmesinin temel nedeni aşağıdakilerden hangisidir?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi Geometrik Sans yazı karakterlerine örnek olarak gösterilebilir?**
    - **Cevap A-) Futura**
    - B-) Garamond
    - C-) Times
    - D-) Bodoni
    - E-) Centaur
    <hr />
1. **Arts & Crafts Hareketi’nin öncüsü William Morris'in 1890’da kaynağı tümüyle kaligrafik olarak tasarladığı yazı karakteri aşağıdakilerden hangisidir?**
    - **Cevap A-) Golden Type**
    - B-) Clarendonlar
    ...
    - E-) Monotype
    <hr />
1. **Su ile yağın birbirini itmesi, su ve yağın karışmaması prensibine dayanan teknik aşağıdakilerden hangisidir?**
    - A-) Neo-Grotesk
    - B-) Grotesque
    - C-) Tipografi
    - D-) Fotodizgi
    - **Cevap E-) Litografi**
    <hr />
1. **Hareketli ilk baskı kalıpları hangi ülkede ortaya çıkmıştır?**
    - **Cevap A-) Çin**
    - B-) İtalya
    - C-) Fransa
    - D-) İngiltere
...
1. **Arts & Crafts Hareketi’nin öncüsü olan ve Golden Type adını verdiği yazı karakterini tasarlayan kişi aşağıdakilerden hangisidir?**
    ...
    - E-) Louis Moyroud
    <hr />
1. **Aşağıdakilerden hangisi su ile yağın birbirini itmesi; su ve yağın karışmaması prensibine dayanan bir tekniktir?**
    - A-) Fotodizgi
    - **Cevap B-) Litografi**
    - C-) Gravür
    - D-) Dijital baskı
    - E-) Tipo baskı
    <hr />
1. **Aşağıdakilerden hangisi nötrlüğü ifade gücü nedeniyle tüm zamanların en çok kullanılan yazı karakterinden biridir?**
    - **Cevap A-) Helvetica**
    - B-) Grotesk
    - C-) Gotik
    - D-) Slab Serif
    - E-) Batone
    <hr />
1. **Sanayi Devrimi’nin ardından ortaya çıkan, aşırı harf yüksekliğine, genişliğine, çok büyük seriflere sahip; kimi zaman fazlasıyla genişletilmiş, kimi zamansa dar bir ilan alanına sığdırılma hedefiyle olağandışı şekilde darlaştırılmış yazı karakterlerine ne ad verilir?**
    - A-) Gotik
    - B-) Grotesk
    - **Cevap C-) Fat Face**
    - D-) Bodoni
    - E-) Didot
    <hr />
1. **Aşağıdakilerden hangisi Linotype ve Monotype makinelerin dizgi alanına getirdiği yeniliklerden biridir?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi fotodizgi tekniği ile kullanılmak üzere tasarlanan yazı karakterlerinde ışık tuzaklarından kaçınmak amacıyla alınan tasarım kararlarındandır?**
...
1. **Aşağıdakilerden hangisi harflerin biçimlerinin sayısal olarak kayıt edildiği dijital sistemin temel prensibidir?**
    ...
    <hr />
1. **Sayısallaştırılan ilk harflerde eğri çizgilerin ve yuvarlatılmış hatların bulunmamasının nedeni aşağıdakilerden hangisidir?**
    ...
    <hr />
1. **Aşağıdaki ifadelerden hangisi Wim Crouwel tarafından tasarlanan New Alphabet’in tipografi tarihi için önemini açıklar?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi masaüstü yayıncılığın etkilerinden biri değildir?**
    ...
    <hr />
1. **Lo-Res yazı karakterinin Zuzana Ličko tarafından tasarlananmasının temel nedeni nedir?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi “anti-alised” (kenarları yumuşatılmış) fontların bitmap fontlardan temel farkını açıklar?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi “PostScript” yazılım diline verilen bir diğer isimdir?**
    - A-) Bitmap
    - **Cevap B-) Type1**
    - C-) OpenType
    - D-) TrueType
    - E-) Unicode
    <hr />
1. **Aşağıdakilerden hangisi TrueType’ın özelliklerinden biri değildir?**
    ...
    <hr />
1. **Aşağıdaki font formatlarından hangisi teknik üstünlüğü nedeniyle PostScript ve TrueType arasındaki rekabetin son bulmasını sağlamıştır?**
    - A-) Type 1
    - **Cevap B-) OpenType**
    - C-) Unicode
    - D-) Rasterizer
    - E-) Hinting
    <hr />
1. **Aşağıdakilerden hangisi ekran için tasarlanan fontlara örnek gösterilebilir?**
    - A-) Futura
    - B-) Garamond
    - **Cevap C-) Verdana**
    - D-) Bodoni
    - E-) Centaur
    <hr />
1. **1919 yılında, dijital teknolojilerin kullanılmaya başlanmasının çok öncesinde, tasarımın ve sanatın sadeleşmesini savunan De Stijl hareketinin kurucusu aşağıdakilerden hangisidir?**
    ...
    - E-) Steve Jobs
    <hr />
1. **Aşağıdakilerden hangisi ekran için tasarlanan, Microsoft tarafından sipariş edilen yazı karakteridir?**
    - A-) Futura
    - B-) Centaur
    - **Cevap C-) Tahoma**
    - D-) Bodoni
...
1. **Masaüstü yayıncılık hakkında aşağıdakilerden hangisi yanlıştır?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi 1984’te kurulan Emigré’nin özelliklerinden biri değildir?**
    ...
    <hr />
## Unite 7
1. **Aşağıdakilerden hangisi 1990’lı yıllara gelindiğinde mükemmel yazı karakteri arayışının son bulmasının temel nedenidir?**
    ...
    <hr />
1. **1990’da P. Scott Makela’nın geleneksel ve serifli bir font olan Centennial ile bir Pop klasiği olan VAG Rounded’ı bir araya getirerek Dead History’yi (Ölü Tarih) tasarlaması tipografi tarihinde nasıl bir ilkin gerçekleşmesine yol açar?**
    ...
    <hr />
1. **FF Scala yazı ailesinin “süper aile” olarak tanımlanmasının nedeni aşağıdakilerden hangisidir?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi 20. yüzyılın sonunda tipografi alanında görülen büyük değişimlerin nedenlerinden biri değildir?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi duyarlı yazı karakterlerine ihtiyaç duyulmasının temel nedenidir?**
    ...
    - E-) Emigré Dergisi için yeni font arayışları
    <hr />
1. **Aşağıdaki seçeneklerden hangisinde parametrik bir font örneği yer almaktadır?**
    - **Cevap A-) Spectral**
    - B-) Mrs Eaves
    - C-) FF Scala
    - D-) Dead History
    - E-) Template Gothic
    <hr />
1. **Değiştirilebilir fontların oluşturulmasının ilk aşaması aşağıdakilerden hangisidir?**
    ...
    <hr />
1. **1990’da Just van Rossum ve Erik van Blokland tarafından tasarlanan Beowolf yazı karakterinin türünün ilklerinden olması hangi özelliğinden kaynağını alır?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi Metafont sayesinde mümkün olmuştur?**
    ...
    <hr />
1. **Aşağıdakilerden hangisi Kore kökenli Sang Mun tarafından çevrim içi gözetleme mekanizmaları olarak özetlenebilecek Optical Character Recognition (OCR, Optik Karakter Tanıma) ve Text Recognition (Metin Tanıma) sistemleri tarafından algılanmayı engellemek için tasarlanan bir yazı karakteridir?**
    - **Cevap A-) ZXX**
    - B-) IBM
    - C-) OCR
    - D-) Google+
    - E-) Twitter
    <hr />
1. **Deneysel bir yöntemle bozuk tipografik malzemelerin, kusurlu biçimlerin bir araya getirilmesiyle oluşturulan Template Gothic yazı karakterini kim geliştirmiştir?**
    - A-) P. Scott Makela
    - B-) Zuzana Licko
    - C-) John Baskerville’
    - **Cevap D-) Barry Deck**
...
1. I. OpenType’ın geliştirilmesi<br />II. Unicode’un geliştirilmesi<br />III. İnternet kullanımının yaygınlaşması<br />IV. Baskı teknolojilerinin geliştirilmesi<br />**Yukarıdaki ifadelerden hangileri 20. yüzyılın sonunda tipografi alanında görülen değişimlerdendir?**
    ...
    - E-) I, II, III ve IV
    <hr />
1. **19. yüzyılda, Joseph A. David tarafından “Plaque Découpée Universelle” (Evrensel Modüler Şablon) isimli şablon aşağıdaki ifadelerden hangisini içermez?**
    - A-) Majüskül harfler
...
1. I. Work Sans<br />II. Canola<br />III. Breite<br />**Yukarıdaki ifadelerden hangisi ya da hangileri metapolator ile geliştirilen ilk yazı ailelerindendir?**
    ...
    - **Cevap E-) I, II ve III**
    <hr />
1. **Aşağıdakilerden hangisi Barry Deck tarafından, deneysel bir yöntemle geliştirilen, bozuk tipografik malzemelerin, kusurlu biçimlerin bir araya geldiği dijital yazı karakteridir?**
    - A-) VAG Rounded
    ...
    - E-) ZXX
    <hr />
1. **Aşağıdakilerden hangisi Mrs Eaves yazı karakterinin özelliklerinden biri değildir?**
    ...
    <hr />
1. **Günümüzde dijital bir font bünyesinde yer alan tüm yazı karakterleri, çizilmeleri basit, ölçümleri hassas ve karmaşık şekillerin kolaylıkla oluşturulabilmesine olanak sağlayan eğrilere ne ad verilir?**
    - A-) Hinting
    - B-) Vector
    - C-) “Anti-alised”
    - D-) Bitmap
