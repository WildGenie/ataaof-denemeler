...
1. <strong>Aşağıdakilerden hangisi reklam grafiği kapsamına giren unsurlardan biri <u>değildir</u>?</strong>
    ...
    - E-) Etiketler
    <hr />
1. <strong>Herhangi bir mal ya da hizmetin, bedeli kim tarafından ödendiği belli olacak şekilde, kitle iletişim araçlarından yer ve zaman satın alarak halka tanıtılmasına yönelik uygulamalara ne ad verilir?</strong>
    - A-) Grafik
    - **Cevap B-) Reklam**
    - C-) Tasarım
    - D-) İlan
...
1. <strong>Reklam tanımında aşağıdaki niteliklerden hangisi <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi tarihsel süreç içerisinde en eski reklam türüne örnek gösterilebilir?</strong>
...
1. <strong>Tarihteki ilk reklam tekrarlama sistemi nerede ve nasıl uygulanmıştır?</strong>
    ...
    <hr />
1. <strong>Reklam, kitlesel bir iletişim biçimi olma niteliğine nasıl kavuşmuştur?</strong>
    - A-) Yazının icadıyla
    ...
    <hr />
1. <strong>Üreticiler, reklamla aşağıdakilerden hangisini <u>amaçlamaz</u>?</strong>
    ...
    <hr />
1. <strong>Tüketicilerin reklam talebine yönelik genel amaçları aşağıdakilerden hangisidir?</strong>
...
1. <strong> Aşağıdakilerden hangisi bir reklam ortamıdır?</strong>
    ...
    - E-) Animasyon
    <hr />
1. <strong>Aşağıdakilerden hangisi hareketli açık hava reklamlarındandır?</strong>
    - A-) Karton adamlar
    - **Cevap B-) Balonlar**
    - C-) Durak panoları
    - D-) Dövizler
...
1. <strong>Aşağıdakilerden hangisi basılı reklam aracı <u>değildir</u>?</strong>
    ...
    - E-) Dergi
    <hr />
1. <strong>Aşağıdaki TV reklamlarından hangisi yayın esnasında akışı engellemeyecek şekilde ses ve söz kullanılmadan ekranın herhangi bir yerinde reklam verilerinin kullanılmasıyla yapılan reklam türüne örnektir?</strong>
    - A-) Basılı reklam
...
1. <strong>Aşağıdakilerden hangisi gazete reklamlarının nitelik ve maliyetini belirleyen unsurlardan biri <u>değildir</u>?</strong>
    ...
    - E-) Renk özelliği
    <hr />
1. <strong>Oluşturulmuş toplu organizasyonlarda firmaların kendilerini ya da mal ve hizmetlerini tanıtmak üzere hedef kitleyle karşılıklı etkileşime girdikleri reklam türü aşağıdakilerden hangisidir?</strong>
    ...
    - E-) Broşürler
    <hr />
1. <strong>Çatı panoları, afişler, tabelalar, karton adamlar hangi reklam ortamında yer alır?</strong>
    - A-) İnternet
    - B-) Dergi
    - C-) Fuar
    - D-) Televizyon
    ...
    <hr />
1. <strong>Görsel unsurlara çokça yer vererek ürünü ya da firmayı doğrudan tanıtmaya yönelik hazırlanmış yüksek maliyetli tanıtım kitaplarına ne denir?</strong>
    - A-) El ilanı
    - B-) Afiş
    - C-) Katalog
    - D-) Dergi
...
1. <strong>Aşağıdakilerden hangisi reklamın temel fonksiyonlarından <u>değildir</u>?</strong>
    ...
    - **Cevap E-) Örgütleme**
    <hr />
1. <strong>Aşağıdakilerden hangisi aldatıcı ve yanıltıcı reklam çeşitlerinden <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklamın toplumsal etkileri bağlamında insanlar üzerindeki etkilerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklamın bilgilendirme özelliği aracılığıyla hedef kitleye <u>anlatılmaz</u>?</strong>
    ...
    <hr />
1. <strong>Kültürel unsurlar doğrultusunda oluşturulan bir reklam grafiğinde aşağıdakilerden hangisi dikkate <u>alınmaz</u>?</strong>
    ...
    <hr />
1. <strong>Yabancı bir ülkeye yönelik oluşturulacak reklam stratejisinde aşağıdakilerden hangisinin dikkate alınması <u>gereksizdir</u>?</strong>
...
1. <strong>''Benzerleri arasında ürün ya da hizmetlerin ayırıcı özelliklerini öne çıkararak markanın bilinirliğini ve tercih edilirliğini artırmak, tüketicilerin ürün veya markayla ilgili tutum/tercihlerini değiştirmek, tüketicileri tanıtımı yapılan ürün ya da hizmeti denemeye yönlendirmek'' şeklinde tanımlanan reklam fonksiyonu aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>Çocuklara yönelik reklamlarda aşağıdakilerden hangisine dikkat etmek gerekli <u>değildir</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi reklamın toplumsal etkileri bağlamında insanlar üzerindeki etkilerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam etiği bağlamında çokça eleştirilen konulardan biri <u>değildir</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi reklamın temel fonksiyonlarındandır?</strong>
    ...
    - E-) Motivasyon
    <hr />
1. <strong>Aşağıdaki reklam sloganlarından hangisi yanıltıcı reklam kapsamında değerlendirilebilecek özelliğe sahiptir?</strong>
    ...
    <hr />
1. <strong>Reklamın toplum üzerindeki etkilerinin olumsuz sonuçları arasında aşağıdakilerden hangisi <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Üreticiler açısından reklamın toplumsal etkisi aşağıdakilerden hangisiyle ilgili <u>değildir</u>?</strong>
    - **Cevap A-) Tatmin**
    - B-) Üretim
    - C-) Tüketim talebi
    - D-) İstihdam
    - E-) Markalaşma
    <hr />
1. Reklam, özel yaşamı bölüp taciz eden bir uygulama olarak görüldüğünden reklamlar dikkat çekici bir özür dileme havasındadır. Belirgin bir romantizm, güzel bir manzara, hoşa gidecek bir hikâye, şiir, sükûnet, dinginlik reklamların en önemli parçalarını teşkil eder.<br /><strong>Yukarıda özellikleri belirtilen reklam anlayışı, hangi ülkeye aittir?</strong>
    - A-) İngiltere
    - B-) Fransa
    ...
    - E-) Almanya
    <hr />
1. <strong>Aşağıdakilerden hangisi bilinçaltı reklamların özelliklerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklamın tüketici üzerindeki sosyolojik etkilerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Reklam mesajı oluşturulurken yeşil renge İslam ülkelerinde kutsaliyet atfedildiğinin, beyazın Hong Kong’da ölüm ve cenazeyi çağrıştırdığının, siyahın Anadolu’da yası temsil ettiğinin dikkate alınması aşağıdakilerden hangisiyle açıklanabilir?</strong>
    ...
    <hr />
## Unite 3
1. <strong>Aşağıdakilerden hangisi reklam metninin özelliklerinden biri <u>değildir</u>?</strong>
    - A-) Açıklık
    ...
    - E-) İkna edicilik
    <hr />
1. <strong>Verilmek istenen mesajı, amaca uygun düşecek biçimde iletmek üzere tasarlanan her türlü yazılı ve görsel ifade aşağıdakilerden hangisinin genel tanımı olabilir?</strong>
    ...
    - E-) Reklam mesajı
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam metnin özgünlük özelliğine uygun <u>düşmez</u>?</strong>
    ...
    <hr />
1. <strong>Dramatik yapı içerisinde kurgulanmış bir hikâye aracılığıyla ürün ya da hizmetin anlatıldığı, genellikle mizah, romantizm, hüzün, özlem vb. duygusal yoğunlukların ön plana çıkarıldığı reklam metin türü hangisidir?</strong>
    ...
    <hr />
1. <strong>Reklamın diğer ögelerinin ortaya koyduğu fikri açıklayan, ürün ya da hizmetle ilgili genel bilgilendirmenin yapıldığı, mesajın net bir şekilde aktarıldığı reklam metni ögesi hangisidir?</strong>
    - A-) Başlık
    - B-) Slogan
    - C-) Alt başlık
    - **Cevap D-) Gövde metni**
    - E-) Logo
    <hr />
1. <strong>Aşağıdakilerden hangisi kullanılış biçimlerine göre reklam başlıkları arasında <u>yer almaz</u>?</strong>
    - A-) Zorlayıcı başlık
    - B-) Seçici başlık
    - C-) Durum başlığı
    ...
    <hr />
1. <strong>Reklam metninde ürünün özellikleri ifade edilirken aşağıdakilerden hangisi dikkate <u>alınmaz</u>?</strong>
    ...
    <hr />
1. <strong>Reklam metninin anlatım biçimi ve dili ile ilgili aşağıdakilerden hangisi <u>söylenemez</u>?</strong>
    ...
    <hr />
1. <strong>“Sizler de aramıza katılabilirsiniz.” ya da “Bu fırsatı kaçırmayın.” şeklinde oluşturulmuş reklam metni başlıkları hangi tür başlık örnekleridir?</strong>
    - A-) Zorlayıcı başlık
    ...
    - E-) Durum başlığı
    <hr />
1. <strong>Logo ile ilgili olarak aşağıdakilerden hangisi <u>söylenemez</u>?</strong>
    ...
    <hr />
1. <strong>Reklam metni aşağıdakilerden hangisini <u>içermez</u>?</strong>
    - A-) Başlık
    - B-) Alt başlık
    - C-) Gövde metni
    - D-) Slogan
    - **Cevap E-) Brief**
    <hr />
1. <strong>Aşağıdakilerden hangisi basılı araçlar için oluşturulmuş reklam metninin yayınına uygun <u>değildir</u>?</strong>
    - A-) Gazete
    - **Cevap B-) Radyo**
    - C-) Dergi
    - D-) Billboard
    - E-) Broşür
    <hr />
1. <strong>Herkesin kolayca anlayabileceği şekilde oluşturulan, içerisinde teknik bilgi bulunmayan, son derece yalın bir şekilde ürün ya da hizmetle ilgili açıklama yapmaya veya bilgi vermeye yönelik oluşturulan reklam metin türü aşağıdakilerden hangisidir?</strong>
...
1. <strong>Genellikle reklam iletisinin başlangıcında veya en üst satırında ilk bakışta dikkat çekmek, ilgi uyandırmak ve metnin içeriği ile ilgili fikir vermek amacıyla dikkat çekici, kalın ya da büyük harflerle oluşturulan bir/birkaç kelime ya da bir cümle şeklindeki reklam metni unsuru aşağıdakilerden hangisidir?</strong>
    ...
    - E-) Reklam metni
    <hr />
1. <strong>Aşağıdakilerden hangisi kullanılış biçimlerine göre reklam başlıklarından biri <u>değildir</u>?</strong>
    ...
    - E-) Sorulu başlık
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam metninde ürün/hizmet özelliklerini ifade edebilmek için cevabı aranacak sorulardan <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam metninin anlatım biçimini ve dilini <u>etkilemez</u>?</strong>
    ...
    <hr />
1. <strong>“Hep daha iyiyi iste!”, “Hemen al, pişman olma” şeklindeki reklam metni başlıkları hangi tür başlıklara örnektir?</strong>
    ...
    <hr />
1. <strong> Bir markayı, firmayı, kurumu, kuruluşu, topluluğu veya fikri temsil eden, adını ve amacını tanımlayan, içeriğinde grafiksel unsurların yer aldığı semboller aşağıdakilerden hangisidir?</strong>
    - A-) Billboard
    - B-) İllüstrasyon
    - **Cevap C-) Logo**
    - D-) Efekt
    ...
    <hr />
## Unite 4
1. <strong>“Kendisinden başka bir şeyin yerini tutan, daha doğrusu, kendi dışında bir şey gösteren” olarak tanımlanabilen kavram aşağıdakilerin hangisidir?</strong>
    - A-) Göstergebilim
    - **Cevap B-) Gösterge**
    - C-) Gösteren
    - D-) Gösterilen
    - E-) Anlam
    <hr />
1. <strong>Aşağıdakilerden hangisi göstergebilim alanında <u>çalışmamıştır</u>?</strong>
    - A-) Aristoteles
    - B-) John Locke
    ...
    - **Cevap E-) David Hume**
    <hr />
1. <strong>Aşağıdakilerden hangisi dil dışı gösterge türlerinden biri <u>değildir</u>?</strong>
    ...
    - E-) Nitel gösterge
    <hr />
1. <strong>Aşağıdakilerden hangisi nesnesine göre gösterge türlerinden biri <u>değildir</u>?</strong>
    ...
    - E-) Simge göstergeler
    <hr />
1. <strong>Aşağıdaki gösterge türlerinden hangisi "benzerlik" ilişkisine göre yorumlanmaktadır?</strong>
    - A-) Sav gösterge
    ...
    - E-) Önerme gösterge
    <hr />
1. <strong>Aşağıdakilerden hangisi Barthes'in göstergebilim için kullandığı terimlerden biri <u>değildir</u>?</strong>
    - A-) Biçim
    - B-) İçerik
    - C-) Yan anlam
    - D-) Düz anlam
    - **Cevap E-) Index**
    <hr />
1. <strong>"Göstergelerin olduğu gibi algılanması ile elde edilen ilk anlam" şeklinde ifade edilen anlam türü aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Düz anlam**
    - B-) Yan anlam
    - C-) Mecaz anlam
    - D-) Kinayeli anlam
    - E-) Gösterilen anlam
    <hr />
1. <strong>Çağdaş göstergebilim anlayışının temeli aşağıdaki hangi düşünürün çalışmaları ışığında atılmıştır?</strong>
    ...
    <hr />
1. <strong>“Mavi bir gökyüzünde uçan kırmızı balon” göstergesi, aşağıdakilerden hangi ürün ya da firma reklamlarında <u>kullanılamaz</u>?</strong>
    - A-) Uçan balon
    - B-) Eğitim kurumları
    ...
    - E-) Boyama kitabı
    <hr />
1. <strong>“Çalar saat” göstergesi, aşağıdakilerden hangi ürün reklamlarında kullanılabilir?</strong>
    - A-) Çanta
    - **Cevap B-) Kahve**
    - C-) Kitap
    - D-) Telefon
    - E-) Yapıştırıcı
    <hr />
1. <strong>Doğal ya da yapay (oluşturulmuş) işaret sistemlerini sözdizim ve anlambilim çerçevelerinde inceleyen sistem aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>Yunanca kökenli sembol kelimesinden türetilen ve “gösterge” anlamına gelen kavram aşağıdakilerden hangisidir?</strong>
    - A-) Tekmerion
    - **Cevap B-) Semeion**
    - C-) Semeotike
    - D-) Retorik
    - E-) Enea
    <hr />
1. <strong>Göstergebilimin, çeşitli iletişim türlerini ve düzeylerini gerçekleştirmek için yaygın olarak kullanılan bir araç veya araç olduğunu iddia eden ilk kişi kimdir?</strong>
    ...
    <hr />
1. <strong>“Gibi göstermek” olarak ifade edilen kavram aşağıdakilerden hangisidir?</strong>
    - A-) Gösterge
    - B-) Gösterilen
    - C-) Gösteren
    - D-) İroni
    - **Cevap E-) Metafor**
    <hr />
1. <strong>Göstergebilimi “gösterge, gösterilen ve yorumlayıcı” açısından ele alan düşünür aşağıdakilerden hangisidir?</strong>
    - A-) Jean Henri Lambert
    - B-) Ferdinand de Saussure
    - C-) Roland Barthes
    - D-) John Locke
    - **Cevap E-) Charles Sanders Peirce**
    <hr />
1. <strong>“Göstergelerin, düz anlamı dışında, bireylerin kişisel deneyimleri, demografik özellikleri ya da kültürel etkenler gibi değişkenlere bağlı olarak yorumlanan anlamları” olarak ifade edilen kavram aşağıdakilerden hangisidir?</strong>
    - A-) Düz anlam
    - **Cevap B-) Yan anlam**
    - C-) Mecaz anlam
    - D-) Kinayeli anlam
...
1. <strong>Aşağılardakilerden hangisi reklam grafiklerinde tipografik tasarımlarda dikkat edilmesi gereken temel kurallardan biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam grafiklerinde tipografinin işlevlerinden biri olarak gösterilebilir?</strong>
...
1. <strong>Aşağıdakilerden hangisi reklam grafiklerinde uygulanan tipografinin metinsel anlatımlarından biri <u>değildir</u>?</strong>
    ...
    - E-) İçerik bilgisi
    <hr />
1. <strong>I. </strong>Bilgi aktarma<br />II. İkna etme<br />III. Dikkat çekme<br /><strong>Yukarıdakilerden hangisi ya da hangileri reklamlarda tipografinin temel amaçları arasında yer alır?</strong>
    - A-) Yalnız I
    - B-) Yalnız II
    - C-) I ve II
    - D-) II ve III
    - **Cevap E-) I, II ve III**
    <hr />
1. <strong>Reklam grafiklerinden tipografi aşağıda sıralanan hangi amaçla kullanılmış <u>olamaz</u>?</strong>
    ...
    <hr />
1. I. Bilgi aktarmak<br />II. İkna etmek<br />III. Dikkat çekmek<br /><strong>Yukarıdakilerden hangisi ya da hangileri reklamlarda tipografinin amaçlarındandır?</strong>
    - A-) Yalnız I
    - B-) Yalnız III
    - C-) I ve II
    - D-) II ve III
    - **Cevap E-) I, II ve III**
    <hr />
1. <strong>Doğru yazı tipi seçiminin reklam grafiklerinde uygulanan tipografik tasarımdaki önemi aşağıdakilerden hangisi <u>olamaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam grafiklerinde doğru yazı tipi seçimi/uygulamasında dikkat edilmesi gereken hususlardan biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Reklam grafiklerinde tipografik uygulamalar aşağıdakilerden hangisini amaçlıyor <u>olamaz</u>?</strong>
    - A-) Bilgi vermek
    - B-) İkna etmek
    - C-) İlgi çekmek
    ...
    <hr />
1. <strong>Tipografinin reklam grafiğindeki yeri ve önemini aşağıdakilerden hangisi en doğru şekilde aktarmaktadır?</strong>
    ...
    <hr />
1. <strong>Reklam grafiğinde tipografinin önemi ve yeri aşağıdaki ifadelerden hangisinde doğru ifade edilmiştir?</strong>
    ...
    <hr />
1. <strong>Reklam grafiğinde tipografik tasarımda yazı tipi seçimi neye bağlı <u>değildir</u>?</strong>
    - A-) Marka kimliği
...
1. <strong>Reklam grafiğinde tipografik hiyerarşi neyi ifade eder?</strong>
    ...
    <hr />
1. <strong>Gutenberg’in hareketli hurufat sistemini geliştirmesi öncesi dönemde reklam grafiklerinde tipografi hangi amaçlarla kullanılmıştır?</strong>
    - A-) Yaratıcı fikir
    - B-) Görsel faktör
    ...
    - E-) Dikkat çekme
    <hr />
1. <strong>Matbaanın ilk dönemlerinde basılı ilanlarda kullanılan yazı tipi aşağıdakilerden hangisidir?</strong>
    - A-) Copper plate
    - B-) Comic Sans
    - **Cevap C-) Gotik**
    - D-) Calibri
...
1. <strong>Aşağıdakilerden hangisinde reklam mecrası kavramı doğru tanımlanmıştır?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi geleneksel reklam mecralarının özelliklerinden biri <u>olamaz</u>?</strong>
    ...
    <hr />
1. <strong>Gazetelerde yer alan ve sıklıkla kullanılan reklam türleri aşağıdakilerden hangisinde tam ve doğru bir şekilde verilmiştir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi yazılı basın reklam araçlarının özelliklerinden biridir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi gazetelerde yer alan teşhir reklam grafiği özellikleri arasında <u>yer almaz</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi yazılı basın reklam ortamıdır?</strong>
    ...
    - E-) El İlanı
    <hr />
1. <strong>Aşağıdakilerden hangisi gazetelerde yer alan kamu duyuruları reklam grafiği özellikleri arasında <u>yer almaz</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi dergi reklam mecrasının avantajlarından biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Gazetelerin reklam ortamı olarak kullanılmasında aşağıdakilerden hangisi ön plana çıkmaktadır?</strong>
...
1. <strong>Aşağıdakilerden hangisi geleneksel reklam mecralarından biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi geleneksel reklam mecralarının özellikleri arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi gazete teşhir reklam grafiğinin özelliklerinden biridir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakiler hangi ikisi en çok tercih edilen yazılı basın reklam aracıdır?</strong>
    - A-) Katalog-Broşür
    ...
    - E-) Broşür-El ilanı
    <hr />
1. <strong>Aşağıdakilerden hangisi el ilanları reklam grafiğinin özellikleri arasında <u>yer almaz</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi dijital reklam mecralarından biri <u>değildir</u>?</strong>
    ...
    <hr />
## Unite 7
1. <strong>Logosunda üçgen şekle sahip olan bir firmanın iletmek istediği mesaj aşağıdakilerden hangisi <u>olamaz</u>?</strong>
    - A-) Yol gösterici
    - B-) Güç
    - C-) Enerji
    - **Cevap D-) Sonsuzluk**
    - E-) İstikrar
    <hr />
1. <strong>Kurum ve kuruluşlara kimlik kazandıran, sözcük özelliği göstermeyen, soyut ya da nesnel görüntülerle ya da harflerle oluşturulan simgelere ne ad verilir?</strong>
    - **Cevap A-) Amblem**
    - B-) Logo
    - C-) Logotype
    - D-) Kurum adı
...
1. <strong>Aşağıdakilerden hangisi kırmızı ile <u>ilişkilendirilmez</u>?</strong>
    ...
    - E-) Tehlike
    <hr />
1. <strong>Bir kurumun her yerde aynı bir isim, renk ve aynı yazı karakteri kullandığı yani tek bir görsel kimlik oluşturduğu kurumsal kimlik türüne ne ad verilir?</strong>
    - A-) Onaylanmış kimlik
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi g</strong><strong>örsel kimliğin temel elemanlarından biri <u>değildir</u>?</strong>
    - A-) Renk
    - B-) Tipografi
    - C-) Logo
    - D-) Kurum adı
...
1. <strong>Sarı renk aşağıdaki kavramların hangisi ile ilişkilendirilebilir?</strong>
    ...
    - E-) Şeffaflık
    <hr />
1. <strong>Kare formundan yararlanılarak yapılan bir kurumun logosunun hangi özelliği taşıdığı söylenir?</strong>
    - **Cevap A-) Sağlamlık**
    - B-) Sonsuzluk
    - C-) Belirsizlik
    - D-) Kararsızlık
    - E-) Zayıflık
    <hr />
1. <strong>Kurum adı tırnaklı bir yazı karakteri ile tasarlanmış şirket aşağıdakilerden hangisinin özelliğini taşır?</strong>
    ...
    <hr />
1. <strong>Görsel kimliği yeşil ağırlıklı olan bir gıda firmasının hedef kitleye verdiği mesaj aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>Kurum veya hizmet adının harf, kelimeler ve/veya görüntü gibi çeşitli görsel ögeler kullanılarak sembolize edilmesine ne ad verilir?</strong>
    - **Cevap A-) Logo**
    - B-) Amblem
    - C-) Slogan
    - D-) Logotype
    - E-) Görsel kimlik
    <hr />
1. <strong>Bir şirket veya marka için tasarlanmış tipografi veya belirli bir biçimde yazılan sözcük ya da sözcüklerden oluşan kurum, ürün veya hizmet adına ne ad verilir?</strong>
    - A-) Amblem
    - B-) Logo
    - **Cevap C-) Logotype**
    - D-) Slogan
...
1. <strong>Aşağıdaki kavramlardan hangisi mavi renk ile ilişkilendirilir?</strong>
    ...
    - E-) Tutku
    <hr />
1. <strong>Şirketlerin kurumsal kimliklerini, sahip oldukları markaların kimliklerinden ayıran ve çeşitli alt markaları olan kurumsal kimlik türü aşağıdakilerden hangisidir?</strong>
    ...
    - E-) Kolektif kimlik
    <hr />
1. <strong>Aşağıdakilerden hangisi siyah rengin olumlu çağrışımlar yarattığı kavramlardan biri <u>değildir</u>?</strong>
    - A-) Şıklık
    - **Cevap B-) Korku**
    - C-) Zarafet
    - D-) Güç
    - E-) Ciddiyet
    <hr />
1. <strong>Kurumsal logosunda ağırlıklı olarak daire biçiminden yararlanılan bir marka için aşağıdakilerden hangisi <u>söylenemez</u>?</strong>
    ...
    <hr />
## Unite 8
1. <strong>Aşağıdakilerden hangisi yaratıcılığın özelliklerinden biri <u>değildir</u>?</strong>
    ...
    - E-) Akıcılık (fluency)
    <hr />
1. <strong>Aşağıdakilerden hangisi afişlerin en önemli özelliğidir?</strong>
...
1. <strong>Çağdaş afiş tasarımın ilk temsilcisi aşağıdakilerden hangisi kabul edilir?</strong>
    ...
    - E-) Yurdaer Altıntaş
    <hr />
1. <strong>Afiş tasarımı, çeşitli sanat akımlarından etkilenmiştir. Aşağıdakilerden hangisi bu akımlardan <u>değildir</u>?</strong>
    - A-) Art Nouveau
    - B-) Jugend stil
    - C-) Arts and Craft
    - D-) Secessionstil
    - **Cevap E-) Realizm**
    <hr />
1. <strong>Afişleri, türlerinin niteliklerine göre kaç bölüme ayırabiliriz?</strong>
    - A-) 2
    - **Cevap B-) 3**
    - C-) 4
    - D-) 5
    - E-) 6
    <hr />
1. <strong>Aşağıdakilerden hangisi genel olarak tasarımın görselleştirme sürecinde izlenilmesi gereken yollardan değildir?</strong>
    ...
    - E-) Problem tanımı
    <hr />
1. <strong>Bir tasarımın görselleştirilmesi ya da tasarım olarak düzenlenip yaratılması için ilk aşaması aşağıdakilerden hangisi olmalıdır?</strong>
    - A-) Uygulama
    - B-) Bilgi toplama
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi Taylor’a göre insan yaratıcılığının beş aşamasından biri <u>değildir</u>?</strong>
    - A-) Üretici
    - B-) Buluşçu
    - **Cevap C-) Yetenekçi**
    - D-) Yaratıcı
    - E-) Gelişmeci
    <hr />
1. <strong>Taylor’a göre “taslaklar” insan yaratıcılığının beş aşamasından hangisi içinde yer alır?</strong>
    - A-) Yaratıcı
    - B-) Yenilikçi
    - C-) Buluşçu
    - **Cevap D-) Dışavurumcu**
    - E-) Üretici
    <hr />
1. <strong>Aşağıdakilerden hangisi “taslak türlerinden” biri <u>değildir</u>?</strong>
...
1. <strong>Aşağıdakilerden hangisi reklam afişlerinden <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Belirli ve göreceli dar kapsamlı bir konuya ilişkin, derlenmiş bilgi parçasına ne ad verilir?</strong>
    - A-) Bilim
    - B-) Teknoloji
    - **Cevap C-) Enformasyon**
    - D-) İdea
    - E-) İnformel Eğitim
    <hr />
1. <strong>Sanayi Devrimi'nden önce grafik tasarım uygulamalarının her aşaması aşağıdakilerden hangisi tarafından yapılmıştır?</strong>
    - A-) Ressamlar
    - B-) Litograflar
    - C-) Fotoğrafçılar
    ...
    - E-) Mücellitler
    <hr />
1. <strong>Aşağıdakilerden hangisi görsel anlatımsal aktarım araçlarından biri <u>değildir</u>?</strong>
    - **Cevap A-) Ses**
    - B-) Leke
    - C-) Çizgi
    - D-) İz
    - E-) Sayı
    <hr />
1. <strong>Bugünkü anlamda ilk afiş sanatı aşağıdaki ülkelerden hangisinde görülmüştür?</strong>
    - A-) Almanya
    - **Cevap B-) Fransa**
    - C-) İtalya
    - D-) Japonya
    - E-) Çin
    <hr />
1. <strong>Tasarım sürecinde “gazete tasarımları” aşağıdakilerden hangi taslakların gelişim evreleri içerisinde yer alır?</strong>
    ...
    <hr />
1. <strong>Tasarım sürecinde “dergiler” taslakların gelişim evrelerinden hangisinin içerisinde yer alır?</strong>
    ...
    <hr />
## Unite 9
1. <strong>Aşağıdakilerden hangisi animasyonun reklam endüstrisindeki getirilerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>“Reklam kampanyalarının sürdürülebilirliği reklam yıldızlarının kariyerlerinin devam ettiği süre ile sınırlıdır. Halbuki animasyon karakterleri marka ve ürün devam ettikçe ona eşlik edecek …………… özelliğine sahiptir.” İfadesinde noktalı yere aşağıdakilerden hangisi gelmelidir?</strong>
    - A-) Zamanlama
    - **Cevap B-) Zamansızlık**
    - C-) Zaman Tasarrufu
    - D-) Zaman Bütçesi
    - E-) Zaman Ayarı
    <hr />
1. Animasyonlar bir şirketin reklam mesajını kısa ve öz bir şekilde izleyicinin izlerken zevk alacağı görsel/işitsel çekiciliğe sahip ……………………. verebilirler.<br /><strong>Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - A-) Ses formatında
    ...
    <hr />
1. <strong>Aşağıdaki tekniklerden hangisi bir animasyon üretim tekniği <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi illüstrasyonun reklama katkılarından biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam illüstrasyonları grubundadır?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi Basın-Yayın İllüstrasyonları grubundadır?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi Bilimsel ve Teknik İllüstrasyonlar grubunda <u>değildir</u>?</strong>
    ...
    <hr />
1. Metinlerin ve fikirlerin tasvir edilmesi ve açıklanması amacıyla uygulanan en yaygın resimleme türüdür.<br /><strong>Tanımı aşağıdakilerden hangisine aittir?</strong>
    - A-) 2B animasyon
    - B-) 3B animasyon
    - C-) Akrilik
    - D-) Lavi
...
1. <strong>Aşağıdakilerden hangisi reklamın işlevlerinden bir tanesi <u>değildir</u>?</strong>
    ...
    - E-) Değer katma
    <hr />
1. Reklamlar nihayetinde .........................…………….. veya korumayı hedefleyen belirli amaçları yerine getirmek için yapılırlar.<br /><strong>Cümlede boş bırakılan yerlere sırasıyla aşağıdakilerden hangisi getirilmelidir?</strong>
...
1. <strong>Aşağıdakilerden hangisinde reklamın işlevi doğru verilmiştir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi animasyonun reklam ile kurduğu farklı türdeki ilişkilerden biri <u>değildir</u>?</strong>
    - **Cevap A-) Tetrad**
    - B-) Endüstriyel
    - C-) Sponsorlu
    - D-) Bilgilendirici
    - E-) İkna edici
    <hr />
1. İnsanlar, dikkat çekme ve sürdürmede rol oynayan çizgi filmlerden hoşlanırlar; animasyon, 'deterjan yiyen lekeler' gibi ……… bir fikre biçim verebilir.<br /><strong>Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - A-) Basit
    - B-) Detaylı
    - C-) Karmaşık
    - D-) Somut
    - **Cevap E-) Soyut**
    <hr />
1. <strong>“İnsanlar, dikkat çekme ve sürdürmede rol oynayan çizgi filmlerden hoşlanırlar; animasyon, ………….. aracılığıyla benzersiz kimlikler yaratır.” İfadesinde boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - A-) Müşteriler
    - B-) Cihazlar
    - **Cevap C-) Markalar**
    ...
    <hr />
## Unite 10
1. <strong>Sanat, belgesel ve endüstriyel alanlarını büyük oranda etkileyen ve aynı zamanda fotoğraf ile ilgili çalışmaların çoğalarak ivme kazanmasında etkili olan Endüstri Devrimi hangi tarihler arasında gerçekleşmiştir?</strong>
    - A-) 1600-1640
    - **Cevap B-) 1660-1740**
    - C-) 1760-1840
    - D-) 1860-1940
    - E-) 1960-2000
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam grafiklerinin özelliklerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. Reklam mecralarının birçoğunda yaratıcı kullanımlara imkan veren ……………., görsel bir mesaj aracı olarak reklam grafiklerinin vazgeçilmez bileşenlerindendir.<br /><strong>Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - **Cevap A-) Fotoğraf**
    - B-) Metin
    - C-) Slogan
    - D-) Başlık
    - E-) Tasarım
    <hr />
1. <strong>1910 yılında Kodak firması için hazırlanmış ve fotoğraf sektörünün ilk yıllarına damgasını vuran “Kodak Girl” reklamının en önemli özelliği aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>1988 yılından itibaren İtalya Vogue dergisinin kapak fotoğraflarını çeken ve fotoğraflarını bir hikâyeyle ilişkilendirerek kurgu belgesel seriler oluşturan fotoğrafçı aşağıdakilerden hangisidir?</strong>
    - A-) Bert Stern
    ...
    - E-) Paul Outerbridge
    <hr />
1. <strong>Aşağıdakilerden hangisi fotoğrafın reklam dünyasında çokça tercih edilmesinin nedenlerinden biri <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Haber veya belgesel fotoğraf türlerinde kendi doğallıklarında kullanılan kişi ve nesnelerin reklam fotoğraflarında kendi doğallıklarında kullanılamama nedeni aşağıdakilerden hangisi olabilir?</strong>
    ...
    <hr />
1. <strong>Reklam grafiklerinde fotoğrafla beraber firmanın veya ürünün markasının ya da metinlerin birlikte kullanılma nedeni aşağıdakilerden hangisi <u>olamaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam fotoğrafının genel amaçları arasında <u>yer alamaz</u>?</strong>
    ...
    <hr />
1. Reklam grafiklerinin bütünü içerisinde yer alan ……………., özellikle mesajın açık bir biçimde algılanabilmesini sağlar.<br /><strong>Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - **Cevap A-) Metinler**
    - B-) Fotoğraflar
    - C-) İllüsrasyonlar
    - D-) Renkler
    - E-) Layoutlar
    <hr />
1. ………………….; bir mal veya hizmetin sürüleceği piyasa ve bu mal veya hizmetin alıcısı olanlar tarafından tanınması için yapılacak araştırmaların, amacının, giderlerinin ve mesaj türlerinin tasarlanması, bütçesi, ne zaman yapılacağı, hangi iletişim araçlarının kullanılacağı konusundaki kararlar ve reklam grafiklerinin hazırlanması gibi faaliyetlerin bütünüdür.<br /><strong>Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - A-) Tasarım
    - B-) İletişim
    - C-) Layout
    - **Cevap D-) Reklam**
    - E-) Ajans
    <hr />
1. Göstergebilimci Roland Barthes, fotoğrafik mesajla ilgili “Image, Music, Text” adlı eserinde fotoğrafın çeşitli anlam düzeylerinde anlaşıldığını belirtmiştir.<br /><strong>Roland Barthes’ın bu ifadesinde vurgulamak istediği düşünce aşağıdakilerden hangisidir?</strong>
    ...
    <hr />
1. <strong>Fotoğraflarında modelini göz kamaştırıcı bir şekilde ön plana çıkaran bir fon aydınlatması, yumuşak netliğe sahip mercekler, etkileyici ışık-gölge düzenlemeleri ve abartılı set tasarımları kullanarak kameranın karşısına geçirdiği kadınları teatral bir güzellikle fotoğraflayan reklam fotoğrafları ile sanatı buluşturan fotoğrafçı aşağıdakilerden hangisidir?</strong>
    - A-) Alfred Stieglitz
    - B-) Thomas Barratt
    ...
    - E-) Louis Daguerre
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam fotoğrafında tasarımın önemi için <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. ………………; reklam grafiklerinde yer alan metinlerin biçimsel özelliklerini ele alan bir disiplindir.<br /><strong>Cümlede boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?</strong>
    - A-) Metin
    - B-) Fotoğraf
    - **Cevap C-) Tipografi**
    - D-) Layout
    ...
    <hr />
## Unite 11
1. <strong>Aşağıdakilerden hangisi ambalajı oluşturan ögelerden biri <u>değildir</u>?</strong>
    - A-) Metin
    - B-) Tipografi
    - C-) Renk
    - D-) Fotoğraf
    - **Cevap E-) Doku**
    <hr />
1. <strong>Günümüzde ambalaj üretim sürecinde hangi baskı tekniği <u>kullanılmaz</u>?</strong>
    - A-) Çukur Baskı
    - B-) Düz Baskı
    - **Cevap C-) Özgün Baskı**
    - D-) Tifdruk Baskı
    - E-) Yüksek Baskı
    <hr />
1. <strong>Aşağıdakilerden hangisi ambalajın ortaya çıkış sebebidir?</strong>
...
1. <strong>Aşağıdakilerden hangisi ambalajın işlevlerinden <u>değildir</u>?</strong>
    ...
    - E-) Kantite İşlevi
    <hr />
1. <strong>Aşağıdakilerden hangisi ambalaj sektörünün bileşenlerinden <u>değildir</u>?</strong>
    ...
    - E-) Marka Uzmanları
    <hr />
1. <strong>Aşağıdakilerden hangisi başarılı ambalajın temel özelliklerinden biri <u>değildir</u>?</strong>
    - A-) Farkındalık
    - B-) İşlevsellik
    ...
    - E-) Koruma
    <hr />
1. <strong>Aşağıdakilerden hangisi tasarım ögelerinden biri <u>değildir</u>?</strong>
    - A-) Çizgi
    - B-) Nokta
    - C-) Leke (Değer)
    - **Cevap D-) Üçgen**
...
1. <strong>Aşağıdakilerden hangisi ambalaj grafiği ile ilgili bilgi <u>vermez</u>?</strong>
    ...
    - E-) Ürün çeşidi
    <hr />
1. <strong>Aşağıdakilerden hangisi ambalajın son aşaması olan üretim sürecinde <u>yapılmaz</u>?</strong>
    ...
    <hr />
1. <strong>Ambalaj tasarımında tüketicinin dikkatini çeken en önemli faktör aşağıdakilerden hangisidir?</strong>
...
1. <strong>Ambalaj tasarımı yaparken kullandığımız kırmızı renk kişide hangi tat duygusunu uyandırır?</strong>
    ...
    - E-) Lezzet
    <hr />
1. <strong>Aşağıdakilerden hangisi marka/logonun görevlerinden biri <u>değildir</u>?</strong>
...
1. <strong>Grafik tasarımcı ambalaj tasarımı yaparken aşağıdakilerden hangisine dikkat etmelidir?</strong>
    ...
    - **Cevap E-) Estetiğine**
    <hr />
1. <strong>Aşağıdakilerden hangisi ambalaj üzerinde kullanılan sembol ve simgelerin kullanım amaçlarından biri <u>değildir</u>?</strong>
    - A-) Güvenlik
    - B-) Uygunluk
    ...
    - E-) İletişim
    <hr />
1. <strong>Aşağıdakilerden hangisi ambalajın üretimi aşamasında dikkat edilecek hususlardan <u>değildir</u>?</strong>
...
1. <strong>Reklam grafiklerindeki mesajlar nasıl <u>olmamalıdır</u>?</strong>
    ...
    - E-) İlgi uyandırmalı
    <hr />
1. <strong>Aşağıdakilerden hangisi internet ve sosyal medyada yer alan reklam grafiklerinde kullanılan görsel iletişim unsurlarından biri <u>değildir</u>?</strong>
    - A-) Uyum
    - B-) Vurgu
    - C-) Bütünlük
    - D-) Görsel hiyerarşi
    ...
    <hr />
1. <strong>Karşı tarafın dikkatini çekmesi için reklam grafiği oluşumunda aşağıdakilerden hangisi ilk kullanılacaklar arasına <u>girmez</u>?</strong>
...
1. <strong>Sosyal medyada yayınlanan reklam grafiklerinin tercih edilme nedeni nedir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi sosyal medyada kullanılan iyi çözümlenmiş reklam grafiklerine örnek <u>verilemez</u>?</strong>
    - A-) Fotoğraf
    - B-) Manipülasyon
    - C-) İllüstrasyon
    - D-) İnfografikler
...
1. <strong>Aşağıdakilerden hangisi reklam grafikleri açısından iletişim süreçlerinden biri <u>değildir</u>?</strong>
    ...
    - E-) Resim
    <hr />
1. <strong>Reklam kelimesi dilimize hangi yabancı dilden geçmiştir?</strong>
    - A-) İngilizce
    - **Cevap B-) Fransızca**
    - C-) Almanca
    - D-) İtalyanca
    - E-) Hintce
    <hr />
1. <strong>Aşağıdakilerden hangisi reklam grafiklerinin amaçları arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Başarılı bir reklam grafiği aşağıdaki özelliklerden hangisine sahiptir?</strong>
    ...
    <hr />
## Unite 13
1. <strong>Aşağıdakilerden hangisi açık hava reklam ürünlerinde kullanılan malzemelerden biri <u>değildir</u>?</strong>
    - A-) Çerçeve
    - **Cevap B-) Fotomontaj**
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi güçlü bir kurumsal markanın ihtiyaçları arasında <u>yer almaz</u>?</strong>
    - A-) Slogan
    - B-) Tema
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi lightbox özelliklerindendir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi billboard türlerinden <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi açık hava reklam ürünlerinden <u>değildir</u>?</strong>
    - A-) Dijital billboard
    - B-) Pole banner
    - C-) Megaboard
    ...
    - E-) Kuleboard
    <hr />
1. <strong>Açıkhava reklam ürünleriyle ilgili aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>Açıkhava reklamcılığının görsel özellikleri tasarım kurallarına, teknik özellikleri malzeme ve uygulama bilgisine, reklamcılıkla ilgili özellikleri hedef kitleyle reklamı yapılan ürün arasındaki bağlantıya dayanmaktadır. Buna göre bir açıkhava reklamının sergilendiği ana kadar olan süreçte hangi alanda çalışmaya ihtiyaç <u>duyulmaz</u>?</strong>
    ...
    <hr />
1. <strong>Açık hava reklamlarında hareket halinde olan tren, otobüs gibi toplu ulaşım araçlarında genellikle dikkat çekici görseller ve okunaklı başlık, slogan kullanımı ve logo kullanımı, aşağıdakilerden hangisiyle bağlantılı <u>değildir</u>?</strong>
    ...
    <hr />
1. <strong>Reklamda mesaj testine göre hangi madde hedef kitleden beklenen yanıt <u>değildir</u>?</strong>
    - A-) Ana mesaj
...
1. <strong>Outdoor TV ile ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>Açık hava reklamcılığıyla ilgili olarak aşağıdakilerden hangisi <u>yanlıştır</u>?</strong>
    ...
    <hr />
1. <strong>Outdoor TV reklamlarının hedef kitleyi etkilemek için taşıması gereken özellikler arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi lightbox ürünleri arasında <u>yer almaz</u>?</strong>
    - A-) Tek taraflı
    - **Cevap B-) Delikli**
    - C-) Özel büküm
    - D-) Kübik
    - E-) Ayaklı
    <hr />
1. <strong>Vinil branda olarak bilinen açıkhava reklam ürünü aşağıdakilerden hangisidir?</strong>
    - **Cevap A-) Mesh**
    - B-) Pole banner
    - C-) Lightbox
    - D-) Megaboard
...
1. <strong>Aşağıdakilerden hangisi tabela uygulama teknikleri arasında <u>yer almaz</u>?</strong>
    ...
    <hr />
1. <strong>Aşağıdaki açık hava reklam ürünlerinden hangisi dijital reklam ürünüdür?</strong>
    - A-) Pole banner
    - B-) Parapet
    - **Cevap C-) Outdoor TV**
    - D-) Raket
    - E-) CLP
    <hr />
1. <strong>Aşağıdaki açıkhava reklam ürünlerinden hangisi aynı anda 6 adet posterin gösterimine olanak sağlar?</strong>
    - A-) Kuleboard
    - **Cevap B-) Silindir**
    - C-) Mesh
    - D-) Raket
    ...
    <hr />
## Unite 14
1. <strong>Aşağıdakilerden hangisi tüketiciyi etkilemek için reklamlarda kullanılan uyarıcılar arasında <u>yer almaz</u>?</strong>
    - A-) Duygusal
    ...
    <hr />
1. <strong>Maslow’un Gereksinimler Hiyerarşisi sıralaması aşağıdakilerden hangisinde doğru olarak verilmiştir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi hem basılı medya hem sayısal medyada sunulan grafik ürünleri arasında yer almaktadır?</strong>
    - A-) E-kitap tasarımı
...
1. <strong>Araştırma hangisi hem açık havada hem iç mekânda kullanılan grafik ürünleri arasında <u>yer almaz</u>?</strong>
    ...
    - **Cevap E-) Raf kart**
    <hr />
1. Hedef kitleyle ilgili bilgileri netleştirmek, ürünün veya hizmetin tanıtımında kullanılacak yöntemi seçmeye yardımcı olmaktadır.<strong><br />Buna göre aşağıdakilerden hangisi reklamlar tasarlanmadan önce hedef kitleyle ilgili toplanan bilgiler arasında <u>yer almaz</u>?</strong>
    - A-) Cinsiyet
    ...
    - E-) Ekonomik durum
    <hr />
1. <strong>Aşağıdakilerden hangisi ürün konteyneri (dump bin) içinde <u>sergilenemez</u>?</strong>
    - A-) Şeker
    - B-) Çikolata
    - C-) Flash bellek
    - D-) Oyuncak
    - **Cevap E-) Televizyon**
    <hr />
1. <strong>Aşağıdaki promosyon ürünlerinden hangisi tekstil ürünü <u>olamaz</u>?</strong>
    - **Cevap A-) Plaket**
    - B-) T-shirt
    - C-) Şapka
    ...
    - E-) Önlük
    <hr />
1. <strong>Aşağıdaki promosyon ürünlerinden hangisi sürdürülebilir bir reklam ürünüdür?</strong>
    - A-) Balon
    - **Cevap B-) Bez çanta**
    - C-) Plastik çanta
    - D-) Vinil branda
...
1. <strong>Aşağıdakilerden hangisi kiosk yazılımlarının işlevlerinden hangisi diğerlerinden farklıdır?</strong>
    ...
    <hr />
1. <strong>Aşağıdaki promosyon ürünlerinden hangisi kırtasiye kategorisinde <u>yer almaz</u>?</strong>
    - A-) Kalem
    - B-) Bloknot
    - C-) Ajanda
    - **Cevap D-) Termos**
    - E-) Defter
    <hr />
1. <strong>Aşağıdakilerden hangisi kurumsal kimlik çalışmaları grubunda <u>yer almaz</u>?</strong>
    - A-) Antetli
    - B-) Diplomat zarf
    - C-) Logo tasarımı
    - **Cevap D-) Bloknot**
...
1. <strong>Aşağıdaki gerilla reklamcılık örneklerinden hangisi iç mekân reklam ürünlerine dâhildir?</strong>
    ...
    <hr />
1. <strong>Aşağıdakilerden hangisi on board reklam ürünüdür?</strong>
